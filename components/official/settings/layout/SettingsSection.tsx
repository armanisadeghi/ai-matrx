...
export function SettingsSection({
  ...
  return (
    <section className={cn(variant === "compact" ? "mb-4" : "mb-6")}>
      <header className="flex flex-wrap items-center gap-2 px-4 mb-2">
        {collapsible ? (
          <button
            type="button"
            className="-mx-2 flex min-w-0 flex-1 items-center gap-2 rounded px-2 py-1 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      ...
      {isOpen && (
        ...
        >
          <SettingsSectionProvider title={title}>
            {children}
