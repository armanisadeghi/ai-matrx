...
describe("TableToolbarAction", () => {
  ...
  it("passes the actual action SVG to the tap target at the shared density-controlled size", () => {
    act(() => {
      root.render(
    ...
    expect(icon?.className.baseVal).toContain("--matrx-table-action-icon-size");
    expect(icon?.className.baseVal).toContain("1.25rem");
