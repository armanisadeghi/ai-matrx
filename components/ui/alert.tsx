 ...
 *
 * A destructive Alert carries the Alchemy Menu through the package's error
 * slot (`ErrorActionsProvider`, mounted in `AlchemyHost`) — the host wrapper
 * that used to add it here is gone, so the menu is never drawn twice.
 *
