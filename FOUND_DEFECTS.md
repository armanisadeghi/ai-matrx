...
### D124 — stale `platform.entity_types` rows → SILENT access denial (2026-08-04; 13 of 18 FIXED, 5 open)
...
### D123 — RESOLVED 2026-08-04: `lib/scheduler-client/claim.ts` never stamped `claim_protocol`
...
### D122 — 🔴 legacy `p_table_name` RPCs: CONFIRMED anonymous RLS bypass (contained 2026-08-04) + still-unidentified caller
