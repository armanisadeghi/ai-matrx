...
const slice = createSlice({
  ...
  reducers: {
    ...
    removeToolsColumn(state, action: PayloadAction<{ columnId: string }>) {
    ...
    setToolsColumns(state, action: PayloadAction<ToolsColumn[]>) {
