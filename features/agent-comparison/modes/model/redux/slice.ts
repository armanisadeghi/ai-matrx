...
const slice = createSlice({
  ...
  reducers: {
    ...
    removeModelColumn(state, action: PayloadAction<{ columnId: string }>) {
    ...
    setModelColumns(state, action: PayloadAction<ModelColumn[]>) {
