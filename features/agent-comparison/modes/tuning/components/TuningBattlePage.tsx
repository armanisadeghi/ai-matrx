...
/**
 * TuningBattlePage — Mode 3 page shell.
 *
 ...
 *   - TuningColumn body is a vertical split: editor on top,
...
export function TuningBattlePage() {
  ...
  const handleDragEnd = (event: DragEndEvent) => {
    ...
    dispatch(reorderTuningColumns({ fromIndex, toIndex }));
  };
...
function ColumnGroup({ columns }: { columns: TuningColumnType[] }) {
  ...
  return (
    <ResizablePanelGroup
      key={groupKey}
      id="agent-comparison-tuning-columns"
