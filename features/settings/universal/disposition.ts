...
const AUDITED: Record<string, SettingsDisposition> = {
  ...
  "tables.pagination.reason": { stateOnlyAt: [], reason: "", consumerEvidence: "lib/data-table/useTablePaginationPolicy.ts resolves this value for approved manual pagination." },
  ...
  "tables.pagination.approved_by": { stateOnlyAt: [], reason: "", consumerEvidence: "lib/data-table/useTablePaginationPolicy.ts resolves this value for approved manual pagination." },
