  ...
  if (loadFailure) {
    ...
    body = (
      <div className="mx-auto w-full max-w-3xl space-y-4 px-4 py-6">
        ...
        {/* No organization notice (Arman, 2026-09-26): a new schedule or
            address, and every run it fires, is stamped server-side with the
            WORKFLOW's organization (`organization_of_parent` in aidream's
            workflow_triggers router) — the selection cannot misfile it. */}
        {freshSecret ? (
