 ...
 * in generated `keyof paths`, restore the typed implementation recorded in
 * the preceding wip commit.
 *
...
function refreshUnavailableWaitingRuns(): void {
  // The live contract is immutable for the lifetime of this build.
}
