  ...
  hr_pay_period_get: {
    ...
    empty: {
      ...
      data: {
        ...
        boundaryNote: null,
        // 🚨 The knob actually OFF, so the Reopen control's absence can be seen rather than assumed.
        reopenAllowed: false,
        reopenNotice: null,
        ...
        rows: [
          {
            ...
            earningCode: "OT", earningCodeName: "Overtime", hoursDelta: 1.5,
            amountDelta: 65.25, amountPending: false, rate: 43.5,
            reasonCategoryName: "Missed punch",
            reasonNote: "Clock-out on 03-12 was recorded 90 minutes early; corrected after lock.",
            workflowInstanceId: "88888888-0000-4000-8000-000000000001",
            workflow: { granted: true, open: [{ instanceId: "88888888-0000-4000-8000-000000000001", flowKey: "timecard_correction", state: "Awaiting payroll approval", deepLink: "/hr/tasks/88888888-0000-4000-8000-000000000001" }], history: [] },
            approvedAt: null, exportedAt: null, createdAt: "2026-03-19T10:12:00Z",
            lockedPeriodNote: "This correction rides the NEXT export, tagged to the original period. The locked period is never rewritten.",
          },
        ],
        page: 1, pageSize: 50, totalRows: 1, hasMore: false,
      },
        ...
        rows: [
          {
            ...
            earningCode: "PRED", earningCodeName: "Predictability pay", hoursDelta: 1,
            amountDelta: null, amountPending: true, rate: null,
            ...
            workflow: { granted: true, open: [], history: [{ instanceId: "88888888-0000-4000-8000-000000000002", flowKey: "timecard_correction", state: "approved", closedAt: "2026-03-20T09:00:00Z" }] },
            approvedAt: "2026-03-20T09:00:00Z", exportedAt: null,
        ...
        rows: [
          {
            ...
            shiftIds: [], workflow: { granted: true, open: [], history: [] },
            // 🚨 The server ships BOTH on every row. Nothing here withholds pay.
            paymentNote: "Overtime that is worked is PAID whether or not this request was approved. A denial is an instruction not to work the hours; it never withholds pay.",
