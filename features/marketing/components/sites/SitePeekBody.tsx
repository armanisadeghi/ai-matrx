...
/**
 * SitePeekBody — the site Quick view's CONTENT, and the only copy of it.
 *
...
export interface SitePeekBodyProps {
  site: SiteListRow;
}

export default function SitePeekBody({ site }: SitePeekBodyProps) {
