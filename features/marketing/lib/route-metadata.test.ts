...
const ROUTES = [
  ...
  ["/marketing/reports/search-console", "Sw"],
  ...
  [`${B}/content/map/map-1/table`, "Mt"],
  [`${B}/content/map/map-1/graph`, "Mg"],
  [`${B}/content/map/map-1/text`, "Mx"],
  [`${B}/content/map/map-1/pages`, "Mp"],
  [`${B}/content/map/map-1/history`, "Mh"],
