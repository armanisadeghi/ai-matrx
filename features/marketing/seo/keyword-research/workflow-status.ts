...
export type KeywordWorkflowStatus =
  (typeof KEYWORD_WORKFLOW_STATUSES)[number];
...
export const KEYWORD_WORKFLOW_STAGES: readonly KeywordWorkflowStage[] = [
  {
    value: null,
    label: "Not tracked",
    description: "No site-specific decision has been made for this keyword yet.",
  },
  {
    value: "candidate",
    label: "Opportunity",
  ...
  },
  {
    value: "targeted",
    label: "Targeted",
    description: "Chosen for the SEO plan and assigned to a page or initiative.",
  },
  {
    value: "in_progress",
    label: "In progress",
...
export const KEYWORD_WORKFLOW_EDIT_OPTIONS = KEYWORD_WORKFLOW_STAGES.filter(
  (stage): stage is KeywordWorkflowStage & {
