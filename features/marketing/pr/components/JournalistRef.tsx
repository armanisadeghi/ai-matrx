...
/** The CRM index is the door for "this person should exist here". */
    ...
    return (
      <span className={cn("inline-flex min-w-0 items-center gap-1.5", className)}>
        ...
        <a
          ...
          title={`${name} has no contact record in your CRM yet. Add them and every future request and piece of coverage links to the same person.`}
