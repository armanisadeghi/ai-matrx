...
| Pending examples            | `components/PendingExamplesPanel.tsx` — shared next-review inventory; admins may replay a conversation or workflow run only after the paid-run confirmation. `wf_node_outcome` is evidence inside a run and is never offered as a replay source.                                                                                                                                                                                                                                                                                              |
