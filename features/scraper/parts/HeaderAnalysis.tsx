...
const HeaderAnalysis = ({ overview }: { overview: Overview }) => {
  ...
  const headerDistribution = useMemo(() => {
    return ScraperDataUtils.getHeaderDistribution(
  ...
  return (
    <div className="w-full bg-textured min-h-dvh">
      <div className="max-w-full px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-textured rounded-xl shadow-md p-6 border-border">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">
                <p>
                  Proper hierarchy follows H1 → H2 → H3 → H4 → H5 → H6 without
                  skipping levels.
                </p>
              </div>
            </div>
              ...
              {Object.keys(headerAnalysis.groupedHeaders).length === 0 ? (
                <div className="px-6 pb-6">
                  <p className="text-gray-500 dark:text-gray-400 text-center py-8">
                    No headers found in the outline.
                  </p>
                </div>
              ) : (
        ...
        {activeTab === "overview" && (
          <div className="bg-textured rounded-xl shadow-md p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Content overview statistics and detailed information will appear
              here.
            </p>
          </div>
        )}
        ...
        {activeTab === "seo" && (
          <div className="bg-textured rounded-xl shadow-md p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              SEO recommendations based on header analysis will appear here.
            </p>
          </div>
        )}
      </div>
