...
export function FieldDetails({ table, fieldName }: FieldDetailsProps) {
  ...
  const [showAdvanced, setShowAdvanced] = useUrlState(
    "advanced",
    booleanUrlCodec(false),
  );
  const [tab, setTab] = useUrlState(
    "fieldTab",
    enumUrlCodec(["details", "component"] as const, "details"),
  );
      ...
      <div className="space-y-6 p-6">
        <div className="space-y-4">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            {!column.is_nullable && <Badge variant="secondary">Required</Badge>}
          </div>
        </div>
              ...
              <CardContent className="space-y-4 pt-6">
                ...
                {showAdvanced && (
                  <div className="pt-4 border-t">
                    <h4 className="text-sm font-medium mb-2">Raw Column</h4>
