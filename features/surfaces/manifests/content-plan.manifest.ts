...
const surfaceSpecific: SurfaceValue[] = [
  ...
  // ── Workspace state (350-399) ─────────────────────────────────────────
  {
    ...
    label: "Current view",
    description:
      "Which workspace view is active: `tree` (tree editor + node panel), `map` (radial pillar map), or `entities` (E-E-A-T entity manager). Always present — defaults to `tree` when the URL carries no `?view=`.",
    valueType: "string",
