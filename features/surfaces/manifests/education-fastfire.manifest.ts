...
const surfaceSpecific: SurfaceValue[] = [
  ...
  },
  {
    ...
    description:
      "The full timing/behavior config as one object: { setId, setName, secondsPerCard, cardLimit, liveScore, spokenFronts, voiceAnswerSeconds, warningSeconds, adaptive }. Always present (defaults before setup). Mirrors the individual values (completeness law). Bindable-only.",
    valueType: "object",
    alwaysAvailable: true,
