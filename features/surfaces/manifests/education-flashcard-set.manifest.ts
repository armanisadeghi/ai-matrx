...
export const educationFlashcardSetManifest: SurfaceManifest = {
  ...
  readiness: "partial",
  readinessNote:
    "The manifest and live deck-detail runtime are wired. DB synchronization and an independently verified production run remain required before this surface can be stamped verified.",
  intro: `<surface_intro>
