        ...
        <div className="mx-auto w-full max-w-6xl px-4 pb-16 sm:px-6 lg:px-8">
            ...
            <section className="flex flex-col gap-4 pt-10 lg:pt-16">
                ...
                <p className="max-w-2xl text-pretty text-base leading-relaxed text-muted-foreground md:text-lg">
                    ...
                    you to carry the work between them. We connected the whole thing into one loop of {stageCount}{" "}
                    steps. Every step is one you can do yourself, hand to an AI agent, or leave running on its own.
                </p>
