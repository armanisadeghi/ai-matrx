...
const MODULES = [
  {
    ...
    title: "Tasks",
    description:
      "Extract action items as the meeting unfolds. Assignees, due dates, priorities — ready to push to your task manager the moment recording stops.",
    badge: "Default",
  },
  {
    icon: NotebookPen,
    title: "Flashcards",
    description:
      "Turn a lecture or training session into a study deck on the fly. Question/answer pairs grouped by topic, ready for review.",
  },
  {
    icon: Network,
    title: "Decisions",
    description:
      "Capture every decision as it's made — the question, the options weighed, the choice landed on, and who drove it. Output as a structured decision tree.",
  },
  {
    icon: Zap,
    title: "Quiz",
    description:
      "Test comprehension as you go. The quiz module builds graded questions from the live content so you can verify retention immediately afterward.",
  },
];
...
const USE_CASES = [
  ...
  {
    title: "Depositions & legal",
    items: [
      "Verbatim raw + cleaned",
      "Per-segment audit trail",
      "Speaker attribution",
      "Inline edits",
    ],
  },
  {
    title: "Sales calls & coaching",
    items: [
      "Decisions made",
      "Follow-up tasks",
      "Objection themes",
  ...
  return (
    <div className="min-h-dvh">
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          aria-hidden
          className="absolute -top-24 -right-24 h-80 w-80 rounded-full bg-primary/10 blur-3xl"
        />
        <div
          aria-hidden
          className="absolute -bottom-24 -left-24 h-80 w-80 rounded-full bg-primary/5 blur-3xl"
        />
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 pt-16 sm:pt-24 pb-12 sm:pb-20 text-center">
          ...
          <p className="mt-6 mx-auto max-w-2xl text-[clamp(1rem,0.95rem+0.25vw,1.25rem)] text-muted-foreground leading-relaxed">
            Four ways in:{" "}
            <span className="font-semibold text-foreground">Scribe</span> — a
            voice-first workspace where you talk to an assistant that builds a
            working document with you; the{" "}
            <span className="font-semibold text-foreground">
              Transcript Studio
            </span>{" "}
            — a four-column live workspace where AI agents clean, structure, and
            analyze your content as you record; a fast file-based{" "}
            <span className="font-semibold text-foreground">Processor</span> for
            one-shot transcripts; and a{" "}
            <span className="font-semibold text-foreground">
              Transcription Cleanup
            </span>{" "}
            pad for one-off AI clean-ups of any recording.
          </p>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-12 sm:py-16">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto">
            Need a transcript right now from a recording you already have? Use
            the Processor. Want to live-capture a 90-minute meeting and walk out
            with action items, concepts, and a clean transcript? Open the
            Studio.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <div
              aria-hidden
              className="absolute -top-12 -right-12 h-48 w-48 rounded-full bg-primary/10 blur-2xl group-hover:bg-primary/15 transition-colors"
            />
            <div className="relative">
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                A four-column live workspace. Record (or paste, or import audio)
                and watch raw text, AI-cleaned text, extracted concepts, and a
                pluggable module column build themselves in parallel — all on
                one synchronized timeline. Built for sessions that run 1–3
                hours, with crash-safe IndexedDB and an audit trail of every
                change.
              </p>
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-5">
              Upload an audio or video file and get a finished transcript back,
              powered by Groq Whisper Large V3 Turbo. Folders, tags, search,
              audio playback, segment editing — everything you need for an
              organized library of finished transcripts.
            </p>
          ...
          >
            ...
            <h3 className="text-2xl font-bold tracking-tight mb-3">Scribe</h3>
            <p className="text-muted-foreground leading-relaxed mb-5">
              Talk to an assistant that builds a working document with you.
              Record takes into sessions, the assistant pulls them in as
              context, and the two of you draft, splice, and edit a real
              document — by voice or text. Audio-first on phone, full editor on
              desktop.
            </p>
            <ul className="grid grid-cols-1 gap-2 mb-6">
              {[
                "Voice-first assistant with auto-send",
                "Working document the assistant edits live",
                "Multi-take sessions with archive + unsort",
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-24">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
              The Transcript Studio is the centerpiece of the system. Four AI
              agents work in parallel, each with its own cadence, all locked to
              one timeline. By the time the conversation ends, the deliverable
              is already done.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-24">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto">
            The fourth column is yours. Pick the module that matches the work —
            and switch mid-session without losing what came before.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              The Transcript Processor is the simple, file-first counterpart to
              the Studio. Drop in an audio or video file, get a clean transcript
              with speakers and timecodes, and organize it into folders
              alongside the rest of your library.
            </p>
            <Button
              size="lg"
      ...
      <section className="bg-card/40 border-y border-border">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 py-16 sm:py-24">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-muted-foreground text-lg max-w-2xl mx-auto">
              One system covers meetings, classes, interviews, depositions,
              sales calls, and content production — because the four columns are
              configurable and the modules are pluggable.
            </p>
          </div>
      ...
      <section className="border-t border-border bg-card/50">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 py-16 sm:py-24 text-center">
          ...
          <p className="mt-4 text-muted-foreground text-lg mb-10">
            Open the Studio for your next call, or push an existing recording
            through the Processor. Everything you produce stays organized,
