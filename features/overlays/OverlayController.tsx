 ...
 *
 * Rules:
 *   - No JSX prop spread in this file (ESLint-enforced, eslint.config.mjs).
 *   - Every overlayId in `OVERLAY_CATALOGUE` (features/overlays/catalogue.ts)
 *     is rendered here exactly once (convention — no automated check).
 */
"use client";
