/**
 * RagHitView — the ONE normalized shape the canonical Knowledge hit card renders.
 *
 * Every Knowledge surface speaks a slightly different hit type (the `knowledge_search`
