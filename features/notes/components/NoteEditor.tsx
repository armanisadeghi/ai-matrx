...
export function NoteEditor({
  ...
  // Lightweight projection of the store's notes map for the surface builder.
  // Memoized on the map reference — NEVER rebuild per keystroke (2026-07
  // freeze class: O(all-notes) work on every render).
  const surfaceNotesMap = React.useMemo(
    () =>
      Object.fromEntries(
