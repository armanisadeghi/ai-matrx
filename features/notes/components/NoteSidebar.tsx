...
export function NoteSidebar({ instanceId }: NoteSidebarProps) {
  ...
  const handleNewNote = useCallback(
    (folder: string) => {
      ...
      dispatch(createAutogeneratedNote({ id, userId, folder, organizationId: requireOrganizationContext(activeOrgId), instanceId }));
    },
    [dispatch, instanceId, userId, activeOrgId, allNotes, selectNote],
  );
