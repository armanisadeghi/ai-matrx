...
export function NotesView({
  ...
  useEffect(() => {
    ...
    // must have finished resolving the current session first.
    if (!authReady) return;
    ...
    // Account switches must get a clean list and a fresh request. The old
    // boolean guard left the new account looking empty forever.
  ...
  }, [authReady, dispatch, resetNotesState, userId]);
