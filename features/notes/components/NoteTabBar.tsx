...
import { draftInitializationErrorMessage, fetchNoteContent, initializeAutogeneratedNote } from "../redux/thunks";
import {
  selectInstanceTabs,
  ...
  const handleNewTab = useCallback(async () => {
    ...
    try {
      await dispatch(initializeAutogeneratedNote({
        ...
        destination: { kind: "create", name: "Draft", organizationId: capturedOrganizationId },
      })).unwrap();
    } catch (error) {
    ...
    >
      ...
      <div className="flex items-stretch shrink-0 bg-background z-10">
        <button
          ...
          title={draftInitializationError ?? "New note"}
          aria-label={draftInitializationError ?? "New note"}
        >
          <Plus />
        </button>
