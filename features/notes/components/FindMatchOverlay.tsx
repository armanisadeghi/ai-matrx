...
// Any style that affects text flow needs to be here. Typed as a Pick over the
// settable string properties (not `keyof CSSStyleDeclaration`, which also
// includes methods like `getPropertyValue`) so indexed get/set both type-check
// honestly.
