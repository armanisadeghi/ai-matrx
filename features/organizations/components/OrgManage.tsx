 ...
 * shell changed.
 *
 * Scroll is owned by `.shell-main` only — no nested overflow container here.
 */
...
export function OrgManage({
  ...
  const RoleIcon =
    userRole === "owner" ? Crown : userRole === "admin" ? Shield : UserIcon;
    ...
    <div className="bg-textured pb-6">
      <div className="max-w-5xl mx-auto p-4 md:p-6 space-y-5 pr-14 md:pr-6">
        ...
        <SectionCard
          ...
          icon={Settings}
          title="General"
          description="Name, logo, website, and description."
        >
          <GeneralSettings
        ...
        {canManageSettings && (
          <SectionCard
            ...
            icon={Mail}
            title="Invitations"
            description="Invite new members by email and manage pending invites."
          >
            <InvitationManager
              organizationId={displayOrganization.id}
        ...
        {canManageSettings && (
          <section id="privacy" className="scroll-mt-16 space-y-2">
            <SectionHeading
              icon={ShieldCheck}
              title="Privacy & ingestion"
              description="Control automatic knowledge ingestion and daily budget."
            />
            <OrgPrivacyTab
              organizationId={displayOrganization.id}
              canEdit={canManageSettings}
        ...
        {canManageMembers && (
          <SectionCard
            ...
            icon={Send}
            title="Email"
            description="Send a message to everyone in this organization."
          >
            <OrgEmailTab
              organizationId={displayOrganization.id}
              organizationName={displayOrganization.name}
