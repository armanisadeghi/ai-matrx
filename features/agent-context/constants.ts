...
> = {
  ...
  datetime: { label: "Date & time", iconName: "CalendarClock" },
  time: { label: "Time", iconName: "Clock" },
  email: { label: "Email", iconName: "Mail" },
  url: { label: "URL", iconName: "Globe" },
  phone: { label: "Phone", iconName: "Phone" },
  percent: { label: "Percent", iconName: "Percent" },
  color: { label: "Color", iconName: "Palette" },
  markdown: { label: "Markdown", iconName: "Pilcrow" },
  currency: { label: "Currency", iconName: "DollarSign" },
