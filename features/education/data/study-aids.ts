    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: AGENT_ICON, title: "Analogies & memory bridges", description: "A relatable comparison for an abstract concept, so the unfamiliar attaches to something you already know." },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: AGENT_ICON, title: "Rich text & markdown", description: "Full formatting, images, and structure — notes are real documents, not throwaway scratch." },
        ],
      },
      {
        kind: "cta",
