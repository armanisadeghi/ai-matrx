...
export const EXAMS: AxisEntry[] = [
  ...
  { slug: "ap-chemistry", name: "AP Chemistry", tagline: "Reactions, equilibrium, and FRQs", description: "Master AP Chemistry units with equation practice and multi-step problem grading.", icon: FlaskConical, letter: "Ch", status: "coming-soon", accessTier: "free", meta: { examFor: "College credit", level: "High school" }, related: { subjects: ["chemistry"], tools: ["tutor", "practice-tests"] } },
