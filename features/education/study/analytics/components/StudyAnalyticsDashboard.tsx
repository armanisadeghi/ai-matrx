...
//
// The unified cross-mode progress dashboard (P5) — promoted to /education/progress.
// Reads the whole study spine (every item_type) via useStudyAnalytics, narrates
// it with the AI narrator, surfaces the highest-leverage weak areas + per-mode
// breakdown + a learning-gain teaser, and reuses StudyTrends for the charts.
// Outcomes lead; hours/streaks never headline (README §6).
//
    ...
    <div className="min-h-full w-full bg-textured">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-5 flex items-center justify-between gap-2">
          ...
          {analytics && analytics.overall.dueNow > 0 && (
            <Button
              size="sm"
              className="gap-1.5"
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-2 rounded-xl border border-dashed border-border bg-card px-6 py-16 text-center">
            ...
            <p className="max-w-sm text-xs text-muted-foreground">
              ...
              trends, and what to study next will show up here.
            </p>
            <Button
              size="sm"
              className="mt-2"
          ...
          <div className="flex flex-col gap-4">
            {/* AI narrative — the "prove it makes you smarter" headline */}
            <NarrativeCard
              report={report}
            ...
            {/* Learning-gain teaser → full report */}
            <LearningGainTeaser
              gain={gain}
              onOpen={() => router.push("/education/progress/learning-gain")}
            />
      ...
      <div className="min-w-0">
        ...
        <p className="mt-0.5 text-xs text-muted-foreground">
          {deltaPct != null
            ...
            : "See your pre/post learning-gain report."}
        </p>
      </div>
