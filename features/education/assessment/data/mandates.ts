...
export const ASSESSMENT_MANDATES = {
  ...
  generateQuiz: MANDATE_KEYS.education__quiz_generate,
  ...
  generateQuizFromSource: MANDATE_KEYS.education__quiz_generate_from_source,
