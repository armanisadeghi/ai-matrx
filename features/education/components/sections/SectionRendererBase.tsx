// Shared section markup for the public server renderer and live admin preview.
// Rich prose is supplied by the entry point so the client graph never imports
// the server-only rich-content renderer.
