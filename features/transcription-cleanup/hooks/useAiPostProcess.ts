 ...
 * Transcription Cleanup page and exposes its streaming state.
 *
 ...
 *   hasn't been loaded yet (e.g. the user opened the page without first
      ...
      try {
        ...
        const cid = await dispatch(
          createManualInstance({
            agentId: agent.id,
            sourceFeature: "transcription-cleanup-page",
