...
export default function UserMenuPanel({ userData }: UserMenuPanelProps) {
  if (!userData) {
    return (
      <div className="matrx-shell-glass w-52 p-1.5 rounded-xl shadow-2xl">
  ...
  return (
    <div className="matrx-shell-glass w-60 max-lg:w-auto p-1.5 rounded-xl max-lg:rounded-2xl max-lg:p-2 shadow-2xl">
