...
/**
 * Compatibility name for the generated LLM parameter contract.
 *
 * This alias must never grow handwritten fields. If the server accepts a
 * legacy name, that name belongs in the Pydantic/OpenAPI schema and therefore
 * appears here through generation. The generated-contract guard rejects a
 * future interface or intersection that tries to extend this boundary.
 */
export type FeLlmParams = LLMParams;
