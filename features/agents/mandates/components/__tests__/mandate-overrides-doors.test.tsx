/**
 * THE DOOR LAW on /agents/mandates: the resolved agent, the system default it
...
jest.mock("../MandateOverridePanel", () => ({
    MandateOverridePanel: () => null,
}));
jest.mock("../../overrides", () => ({
    fetchMandateOverridesData: jest.fn(() =>
        Promise.resolve({
            mandates: [
                {
                    id: "mandate1",
...
import { MandateOverridesPage } from "../MandateOverridesPage";
...
beforeEach(async () => {
    ...
    act(() => {
        root.render(<MandateOverridesPage />);
    });
...
describe("MandateOverridesPage doors", () => {
