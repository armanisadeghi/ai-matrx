...
// NOTE: reading a file's extracted text is the SERVER tool `file_read` (armed
// on the War Room agents' agent.definition rows) — the client-delegated
// `war_room_read_file` was deleted (D15): a client round-trip hard-suspended
// the loop for a read the server does in one hop.
