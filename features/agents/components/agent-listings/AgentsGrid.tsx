        ...
        <div className="mb-3 pt-8">
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 relative">
              <div className="flex items-center gap-3 p-1 rounded-full matrx-shell-glass hover:shadow-xl transition-shadow">
            ...
            <Link href="/agents/new">
              <Button
                size="icon"
                className="h-8 w-8 rounded-full matrx-shell-glass hover:shadow-xl bg-primary hover:bg-primary/90 shrink-0"
