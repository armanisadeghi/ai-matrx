...
> = {
  ...
  datetime: {
    label: "Date & time",
    description: "Calendar + time-of-day picker",
    requiresOptions: false,
    requiresToggleValues: false,
    requiresMinMax: false,
  },
  ...
  url: {
    label: "URL",
    description: "Web link — opens in a new tab",
    requiresOptions: false,
    requiresToggleValues: false,
    requiresMinMax: false,
  },
  ...
  percent: {
    label: "Percent",
    description: "A percentage (0–100), stored as a number",
    requiresOptions: false,
    requiresToggleValues: false,
    requiresMinMax: true,
  },
  ...
  markdown: {
    label: "Markdown",
    description: "Rich text authored as Markdown",
    requiresOptions: false,
    requiresToggleValues: false,
    requiresMinMax: false,
  },
  currency: {
    label: "Currency",
    description: "Money amount with a currency code",
    requiresOptions: false,
    requiresToggleValues: false,
    requiresMinMax: false,
  },
