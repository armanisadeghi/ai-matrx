    ...
    <div className="h-full overflow-y-auto overscroll-contain px-3 py-3">
      ...
      <div className="space-y-1.5">
        ...
        {/* Shape discovery chips — one-click add of the high-value render_block
            ...
            that exist + are active in the live list. Renders its own
            full-width tag flow (chips don't fit the label-column grid) and
            shows nothing on a cold skills slice / zero resolved chips. */}
