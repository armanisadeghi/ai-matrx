 ...
 *
 * FULLY DERIVED from the live directive catalog (`useDirectiveCatalog`) — the server's
 * registries are the single source of truth. The Plane-2 Custom Actions section
