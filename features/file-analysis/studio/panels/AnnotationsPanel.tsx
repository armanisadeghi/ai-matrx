...
export function AnnotationsPanel({
  ...
  return (
    <RawView label="Annotations" rawData={annotations}>
              ...
              {items.map((a) => {
                ...
                return (
                  <li
                    key={a.id}
                    className={cn(
                      "group flex flex-col gap-1 border-b border-border/40 px-2 py-1.5 last:border-0 hover:bg-accent/30",
                  ...
                  >
                    <div className="flex items-start gap-2">
                      ...
                      >
                        ...
                        {a.extracted_text ? (
                          <div className="break-words text-[10px] text-muted-foreground line-clamp-2">
                            {a.extracted_text}
                          </div>
                        ) : null}
                      </button>
                    ...
                    {/* Inline raw — per annotation. Click "Raw" to expand
                     * + see the bbox, page_id, normalized_value, etc. The
                     * exact payload an AI agent can use to extract specific
                     * fields. */}
                    <InlineRawToggle data={a} />
                  </li>
                );
              })}
            </ul>
