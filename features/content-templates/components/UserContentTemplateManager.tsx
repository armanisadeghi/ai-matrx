    ...
    return (
        <div className="flex-shrink-0 px-3 pt-3 pb-2  border-b border-border/40">
            <div className="flex items-center gap-2 p-1.5 rounded-full ">
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            activeTab === "my"
                                ...
                                : "text-glass-foreground hover:matrx-shell-glass"
                        )}
                    >
                        Mine
                        <span className={cn(
                ...
                {/* Search — matrx-shell-glass per spec */}
                <div className="flex-1 flex items-center gap-1.5 h-8 px-2.5 rounded-full matrx-shell-glass min-w-0">
                ...
                {/* Filter — matrx-shell-glass per spec */}
                <button
                    onClick={onFilterClick}
                    className="flex-shrink-0 relative h-8 w-8 flex items-center justify-center rounded-full matrx-shell-glass text-glass-foreground active:opacity-70 transition-opacity"
                >
