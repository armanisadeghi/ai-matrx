...
import { useDraftInitializationControl } from "@/features/notes/hooks/useDraftInitializationControl";
import {
...
export function NotesWindow({
  ...
  // ORG-GATE-AUDIT: "New note" with no organization selected asks (the
  // new-note resolver), then continues — never the bare kernel's refusal.
