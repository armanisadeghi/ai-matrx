...
export interface ActiveContextSelectionEngine {
  universe: Universe;
  engine: SelectionEngine;
}

/**
 * Surface-A selection adapter shared by every canonical active-context face.
 * Toggle operations write the global working context without disturbing the
 * active conversation; context-item checks remain session-local.
 */
export function useActiveContextSelectionEngine(): ActiveContextSelectionEngine {
