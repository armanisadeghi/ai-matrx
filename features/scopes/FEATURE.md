...
- `<ActiveContextLensChip />` / `<LensChip />` — Lens Chip trigger (reimagine T2 face) → Popover/Sheet → `<ActiveContextTree />` (the promoted dense ContextTree). Clear lives in the tree footer. Default chat-header control.
