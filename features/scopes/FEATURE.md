...
|---|---|
| `ContextValueInput` | THE value-entry switch for any `value_type`. Routes `reference` → `ReferenceValuePicker`; `boolean`/`date` get dedicated controls; everything else → `ProTextarea`. |
