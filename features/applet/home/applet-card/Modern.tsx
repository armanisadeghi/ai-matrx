  ...
  return (
    ...
    >
      ...
      <div className="flex items-stretch">
        ...
        <div
          className={`w-16 flex-shrink-0 flex items-center justify-center bg-${primaryColor}-500 dark:bg-${primaryColor}-600`}
        >
          {applet.appletIcon ? (
      ...
      <div className="h-32 w-full relative overflow-hidden bg-gray-100 dark:bg-gray-700">
        ...
        <div className="absolute bottom-0 right-0 m-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div
            className={`bg-${accentColor}-500 dark:bg-${accentColor}-600 text-gray-100 px-4 py-1 text-sm rounded-full font-medium shadow-lg`}
          >
            Open
          </div>
        </div>
      ...
      <div className="p-3 bg-gray-50 dark:bg-gray-800 border-t border-border flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <div
            className={`h-2 w-2 rounded-full bg-${primaryColor}-500 dark:bg-${primaryColor}-600`}
          ></div>
        ...
        <div
          className={`text-xs text-${accentColor}-500 dark:text-${accentColor}-600 font-medium`}
        >
          {applet.slug}
        </div>
      </div>
