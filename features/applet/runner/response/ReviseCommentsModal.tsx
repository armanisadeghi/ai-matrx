...
export default function ReviseCommentsModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-2xl w-full max-h-[90dvh] overflow-y-auto overscroll-contain border border-slate-100 dark:border-slate-700">
        <div className="p-6">
