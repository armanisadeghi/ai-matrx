  ...
  (
    ...
    return (
      <div className={`space-y-6 ${className}`}>
        ...
        {/* App cards */}
        <div
          className={viewMode === "grid" ? getGridColumnsClass() : "space-y-3"}
        >
          {isLoading ? (
            renderSkeletons()
                          ...
                          {onEditApp && (
                            <Button
                              className={`flex-1 bg-transparent border border-current hover:bg-opacity-10 font-bold ${
                                textColorVariants[app.accentColor || "blue"] ||
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ...
                                    permanently remove the app and all its data.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
