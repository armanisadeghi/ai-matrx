...
`WebSocket.onopen` and rejects after four seconds. `TerminalTab` then keeps the
buffered listener active and prints a visible fallback notice. Streaming exec
