...
| HR person / employee                   | `hrPersonMenuSection` + adapters (`hrDirectoryRowTarget`, `leaveBalanceRowTarget`) | `features/hr/people/hr-person-menu.tsx`                             | LeaveEnrollmentSurface (roster + candidates) — future adopters: HrDirectory, HrDirectoryCards, directoryColumns, EmploymentPicker, LeaveDecisionDialogs |
