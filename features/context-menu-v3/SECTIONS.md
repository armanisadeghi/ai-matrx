# Canonical menu sections — THE REGISTRY
...
4. **THE GROWTH STEP (the most important one).** When you adopt an existing section on a new surface, list every action a user would reasonably want for this identity *on this surface*. Almost always the section is missing some. Add them TO THE SHARED BUILDER — every prior consumer gains them. Never bolt a private sibling section next to the shared one for the same identity.
