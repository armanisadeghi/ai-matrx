...
| Site page (by `web.page` id / URL)     | `pageMenuSection`                                                         | same file                                                                    | Insights page-dimension tables · NewPagesTab (launch tracker) · PagesTable · DismissedPagesTable · SitemapDetail · SiteAnalysisTable (priority-queue findings, by their affected page)                                                                                                                                                                         |
