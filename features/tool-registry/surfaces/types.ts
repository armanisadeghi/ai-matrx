 ...
 *
 * See:
 *   - `features/tool-registry/surfaces/manifests/registry.ts`   (the registry)
 *   - `features/tool-registry/surfaces/utils/value-mapping-resolver.ts` (the resolver)
 *   - `features/tool-registry/surfaces/services/manifest-sync.service.ts` (drift + sync)
 */
