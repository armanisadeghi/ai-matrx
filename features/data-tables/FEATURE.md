...
- **Dependency hold (2026-09-23):** keep `@univerjs/core` and `@univerjs/themes` at 0.25.1; updating them alone to 0.25.2 causes four editor type errors while all Univer preset packages remain at 0.25.1.
