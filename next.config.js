...
const PROFILES = {
  ...
  admin: {
    includeDev: false,
    park: ["core", "transitional", "public", "popup"],
  },
  demos: {
    includeDev: true,
...
function syncRouteGroupPark(exclude, liveName, parkedName) {
  ...
  if (exclude) {
    if (fs.existsSync(live)) {
      ...
      console.log(
        `[matrx] app/${liveName} already parked at app/${parkedName}`,
      );
    } else {
      console.warn(
...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: "/settings/message-templates/edit/:id",
        destination: "/chat/message-templates/edit/:id",
        permanent: true,
      },
      {
        source: "/settings/message-templates/new",
        destination: "/chat/message-templates/new",
        permanent: true,
      },
      {
        source: "/settings/message-templates/:id",
        destination: "/chat/message-templates/:id",
        permanent: true,
      },
      {
        source: "/settings/message-templates",
        destination: "/chat/message-templates",
        permanent: true,
      },
      ...
      {
        source: "/content-plan",
        destination: "/marketing/content-plan",
        permanent: true,
      },
      {
        source: "/content-plan/:path*",
        destination: "/marketing/content-plan/:path*",
        permanent: true,
      },
      {
        source: "/seo/keyword-research",
        destination: "/marketing/keyword-research",
        permanent: true,
      },
      ...
      // DID ship, so the redirect is load-bearing.
      {
        ...
        destination: "/crm/outreach-lists",
        permanent: true,
      },
      {
        source: "/crm/campaigns/:path*",
        destination: "/crm/outreach-lists/:path*",
        permanent: true,
      },
      ...
      {
        source: "/administration/sharing",
        destination: "/administration/database/relationships/sharing",
        permanent: false,
      },
      {
        source: "/administration/directive-catalog",
      ...
      {
        source: "/administration/admins",
        destination: "/administration/users/admins",
        permanent: false,
      },
      {
        source: "/administration/invitation-requests",
        destination: "/administration/users/invitations",
        permanent: false,
      },
      {
        source: "/administration/entitlements",
        destination: "/administration/users/entitlements",
        permanent: false,
      },
      {
        source: "/administration/email",
      ...
      },
      {
        ...
        destination: "/transcripts/processor",
        permanent: true,
      },
      {
        source: "/transcription/:path*",
        destination: "/transcripts/:path*",
        permanent: true,
      },
      ...
      {
        source: "/demos/ssr/:path*",
        destination: "/demos/:path*",
        permanent: false,
      },
      { source: "/demos/ssr", destination: "/demos", permanent: false },
      {
        source: "/ssr/demos/:path*",
        destination: "/demos/:path*",
        permanent: false,
      },
      { source: "/ssr/demos", destination: "/demos", permanent: false },
      {
        source: "/ssr/chat/:path*",
        destination: "/demos/chat/:path*",
        permanent: false,
      },
      { source: "/ssr/chat", destination: "/demos/chat", permanent: false },
      {
        source: "/ssr/dashboard/:path*",
        destination: "/demos/dashboard/:path*",
        permanent: false,
      },
      {
        source: "/ssr/dashboard",
        destination: "/demos/dashboard",
        permanent: false,
      },
      ...
      {
        source: "/org/:orgId/projects/:projectId/settings/:path*",
        destination:
          "/organizations/:orgId/projects/:projectId/settings/:path*",
        permanent: true,
      },
      {
        source: "/org/:orgId/projects/:projectId/settings",
        destination: "/organizations/:orgId/projects/:projectId/settings",
        permanent: true,
      },
      {
        source: "/org/:orgId/projects/:projectId/:path*",
        destination: "/organizations/:orgId/projects/:projectId/:path*",
        permanent: true,
      },
      {
        source: "/org/:orgId/projects/:projectId",
        destination: "/organizations/:orgId/projects/:projectId",
        permanent: true,
      },
      {
        source: "/org/:orgId/shortcuts/:path*",
        destination: "/organizations/:orgId/shortcuts/:path*",
        permanent: true,
      },
      {
        source: "/org/:orgId/shortcuts",
        destination: "/organizations/:orgId/shortcuts",
        permanent: true,
      },
      {
      ...
      {
        source: "/org/:orgId",
        destination: "/organizations/:orgId",
        permanent: true,
      },
      ...
      // block.
      {
        source: "/transcript-studio/:path*",
        destination: "/transcripts/studio/:path*",
        permanent: true,
      },
      {
        source: "/transcript-studio",
        destination: "/transcripts/studio",
        permanent: true,
      },
      {
        source: "/transcription/mobile/:path*",
        destination: "/transcripts/scribe/:path*",
        permanent: true,
      },
      {
        source: "/transcription/mobile",
        destination: "/transcripts/scribe",
        permanent: true,
      },
      ...
      ...(INCLUDE_DEV
        ? [
            {
              source: "/tests/:path*",
              destination: "/demos/tests/:path*",
              permanent: false,
            },
            { source: "/tests", destination: "/demos/tests", permanent: false },
            {
              source: "/settings-hooks-demo",
              destination: "/demos/settings-hooks",
              permanent: false,
            },
            {
              source: "/settings-primitives",
              destination: "/demos/settings-primitives",
              permanent: false,
            },
            {
              source: "/settings-shell-demo",
              destination: "/demos/settings-shell",
              permanent: false,
            },
            {
              source: "/settings-tree-demo",
              destination: "/demos/settings-tree",
              permanent: false,
            },
            {
              source: "/layout-tests/:path*",
              destination: "/demos/layout-tests/:path*",
              permanent: false,
            },
            {
              source: "/layout-tests",
              destination: "/demos/layout-tests",
              permanent: false,
            },
            {
              source: "/dynamic-imports/:path*",
              destination: "/demos/dynamic-imports/:path*",
              permanent: false,
            },
            {
              source: "/dynamic-imports",
              destination: "/demos/dynamic-imports",
              permanent: false,
            },
            {
            ...
            {
              source: "/lists-explorer",
              destination: "/demos/lists-explorer",
              permanent: false,
            },
          ]
        : []),
