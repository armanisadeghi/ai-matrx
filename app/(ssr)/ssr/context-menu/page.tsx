 ...
 * EVERY moving part of the v2 context menu. It is NOT the simple smoke
 * test at /ssr/demos/context-menu-v2 — it is the page Arman uses to
...
Select some text first to populate \`selection\`, \`text_before\`, and \`text_after\` in the live applicationScope below.`,
  ...
  return (
    <div className="h-[calc(100dvh-var(--header-height))] flex flex-col overflow-hidden bg-textured">
      {/* ── Header ──────────────────────────────────────────────────── */}
      <div className="border-b border-border bg-card/50 backdrop-blur px-4 py-2 flex items-center justify-between gap-3 flex-shrink-0">
        <div className="min-w-0">
          <h1 className="text-sm font-semibold flex items-center gap-2">
            <Sparkles className="h-3.5 w-3.5 text-primary" />
            UnifiedAgentContextMenu — Diagnostic Lab
          </h1>
          <p className="text-[11px] text-muted-foreground truncate">
            Right-click the trigger area. Every fetched/derived value is shown
            in the panels below. Nothing here re-fetches on render — use the
            refresh buttons.
          </p>
        </div>
