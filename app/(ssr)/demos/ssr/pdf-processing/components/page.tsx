...
/**
 * PDF Canonical Components Bench — /demos/ssr/pdf-processing/components
 *
 ...
 * endpoint-level test pages live at /demos/ssr/pdf-processing.
 */
    ...
    <div className="mx-auto flex h-[calc(100dvh-2.5rem)] max-w-6xl flex-col gap-3 overflow-y-auto p-4">
      <header className="flex flex-wrap items-center gap-3">
        ...
        <p className="text-xs text-muted-foreground">
          ...
          purpose.{" "}
          <Link href="/demos/ssr/pdf-processing" className="underline">
            Endpoint tests →
          </Link>
        </p>
      </header>
