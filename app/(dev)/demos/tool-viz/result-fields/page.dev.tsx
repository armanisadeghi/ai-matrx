...
const FIXTURES: Array<{ label: string; value: unknown }> = [
  ...
  },
  {
    ...
    value: Array.from(
      { length: 12 },
      (_, i) => `Line ${i + 1}: some plain text content here.`,
    ).join("\n"),
  },
  {
    label: "scalar list",
  ...
  },
  {
    ...
    value: [
      {
        id: "0dd1a01c-24af-4c3e-9d6f-092ffaa10e4c",
        name: "Alpha",
        scope_id: "b0bf8b4e-8700-4e9c-9cac-a0cda8c22860",
        status: "active",
      },
      {
        id: "b572b495-2044-421b-a066-6a9f91a0e8b5",
        name: "Beta",
        scope_id: "b0bf8b4e-8700-4e9c-9cac-a0cda8c22860",
        status: "pending",
      },
      {
        id: "1febac7b-aa48-47e2-a677-f7cad1b0937a",
        name: "Gamma",
        scope_id: "565b0782-79ae-4adf-a104-9e6605cbdf90",
        status: "active",
      },
    ],
  },
...
const PATCH_RECORDING = buildSimpleRecording(
  ...
  },
  {
    displayName: "Context",
    workMs: 1600,
    progressMessage: "Updating patient_summary",
  },
);
...
const STATE_ENTRIES: ToolLifecycleEntry[] = [
  ...
  entry({
    ...
    errorType: "execution",
    errorMessage:
      "Connection timed out after 30s while contacting the upstream service.",
    result: null,
  }),
  entry({
    callId: "c3",
...
const RESEARCH_REPORT_ENTRY = researchReportEntry(
  "research_web",
...
const ASK_ENTRIES: ToolLifecycleEntry[] = [
  entry({
    ...
    arguments: {
      question:
        "Should I apply the migration to production now, or wait for the maintenance window?",
    },
    result: {
      answer: "Wait for the maintenance window — run it at 2am UTC.",
      cancelled: false,
    },
  }),
  entry({
    ...
    arguments: {
      introduction:
        "Quick policy questions so I can clean up your inbox without burying anything important.",
      questions: [
        {
          id: "receipts",
          prompt: "Receipts and paid statements — mark all as read?",
          options: ["Yes", "No"],
          component_type: "radio",
        },
        {
          id: "news",
          prompt: "News alerts (breaking-news headlines) — mark as read?",
          options: ["Yes", "No"],
          component_type: "radio",
        },
        {
          id: "security",
          prompt: "Security and login codes — how should I handle them?",
          options: ["Mark read", "Leave unread", "Show me each"],
          component_type: "radio",
        },
      ],
    },
  ...
  entry({
    ...
    result: {
      ...
      entries: [
        {
          name: "matrx-sandbox",
          path: "/home/agent/repos/matrx-sandbox",
          is_dir: true,
          size: 4096,
          mtime: 1783466928,
        },
        ...
        {
          name: "ai-matrx",
          path: "/home/agent/repos/ai-matrx",
          is_dir: true,
          size: 4096,
          mtime: 1783713323,
        },
  ...
  entry({
    ...
    result: {
      ...
      entries: [
        {
          name: "packages",
          path: "/home/agent/aidream/packages",
          is_dir: true,
          size: 4096,
          mtime: 1783712973,
        },
        {
          name: "pyproject.toml",
          path: "/home/agent/aidream/pyproject.toml",
          is_dir: false,
          size: 1843,
          mtime: 1783712973,
        },
        {
          name: "README.md",
          path: "/home/agent/aidream/README.md",
          is_dir: false,
          size: 5210,
          mtime: 1783712973,
        },
...
const DB_RENDERER_ENTRIES: ToolLifecycleEntry[] = [
  entry({
    ...
    result: {
      ...
      entries: [
        {
          name: "matrx-frontend",
          path: "/home/agent/repos/matrx-frontend",
          is_dir: true,
          size: 4096,
          mtime: 1781080487,
        },
        ...
        {
          name: "matrx-extend",
          path: "/home/agent/repos/matrx-extend",
          is_dir: true,
          size: 4096,
          mtime: 1781083058,
        },
        {
          name: "README.md",
          path: "/home/agent/repos/README.md",
          is_dir: false,
          size: 2048,
          mtime: 1781083100,
        },
        {
          name: "deploy.sh",
          path: "/home/agent/repos/deploy.sh",
          is_dir: false,
          size: 512,
          mtime: 1781083111,
        },
  ...
  entry({
    ...
    result: {
      stdout:
        "7317e7de2 fix(chat): agentic turn renders as ONE unit + fold consecutive tool calls\n40e901215 release: v0.3.574\nc36d91c16 bookmark additions",
      stderr: "",
      exit_code: 0,
  ...
  entry({
    ...
    arguments: {
      ...
      action: "store",
      content:
        "Algae-derived omega-3 leads on sustainability + bioavailability; the ratio hypothesis is being challenged in favor of absolute levels.",
      importance: 0.8,
    },
  ...
  entry({
    ...
    result: {
      ...
      content:
        "#!/usr/bin/env bash\nset -euo pipefail\n\n# Build (defaults to MATRX_PROFILE=full) and ship to Vercel\npnpm build\npnpm db-types\nvercel deploy --prod\n",
      size: 156,
      truncated: false,
    },
  }),
      ...
      tabs: [
        {
          ...
          title: "Inbox (2,927) - Gmail",
        },
        {
          id: 2,
          url: "https://github.com/anthropics",
          title: "anthropics · GitHub",
        },
      ...
      matches: [
        {
          ref: "7",
          score: 1,
          reason: "Directly corresponds to the page's search box.",
        },
        {
          ref: "11",
          score: 0.8,
          reason: "Secondary search affordance in the header.",
        },
      ],
    },
  }),
  ...
  entry({
    ...
    result: {
      ...
      elements: [
        {
          href: "https://pypi.org/manage/projects/#content",
        ...
        {
          href: "https://pypi.org/account/login/",
          name: "Log in",
          ref: "ref:8",
          role: "link",
        },
  ...
  entry({
    ...
    result: {
      ...
      matches: [
        {
          context: "Integrations and observability",
          selector: "li:nth-of-type(10) > a",
          tag: "a",
          text: "observability",
        },
        {
          context: "Observability dashboard overview",
          tag: "h2",
          text: "Observability",
        },
      ],
...
function LivePatchSection() {
  ...
  const simEntry = useSimulatedToolEntry(hasPlayed ? PATCH_RECORDING : null, {
    playKey,
  });
  ...
  return (
    <section className="space-y-4">
      ...
      <p className="text-xs text-muted-foreground">
        The patch is known the instant the tool starts (old_str → new_str), so
        the diff renders with NO wait. While live, the removed span tints
        destructive and the replacement fills into place (success), surrounding
        text untouched. Settles on the final diff on completion. Press Play.
      </p>
      <div className="space-y-3">
        <FixtureCard label="PatchDiffInline — LIVE reveal (simulated stream)">
          <PatchDiffInline
            entry={simEntry}
            events={simEntry.events}
            toolGroupId={simEntry.callId}
          />
        </FixtureCard>
      </div>
    </section>
...
function LiveSearchSection() {
  const [playKey, setPlayKey] = useState(0);
  const hasPlayed = playKey > 0;
  const simEntry = useSimulatedToolEntry(hasPlayed ? SEARCH_RECORDING : null, {
    playKey,
  });
  ...
  return (
    <section className="space-y-4">
      ...
      <p className="text-xs text-muted-foreground">
        Rolling-window conveyor: at most ~4 result rows visible at once, deduped
        by base URL (no duplicate favicon), sliding in as older rows flow out.
        On completion it fast-forwards to the clean persistent results view.
        Press Play to run.
      </p>
...
function ResearchStreamSection() {
  const [playKey, setPlayKey] = useState(0);
  const hasPlayed = playKey > 0;
  const simEntry = useSimulatedToolEntry(
    hasPlayed ? RESEARCH_RECORDING : null,
    { playKey },
  );
...
function LiveScrapeSection() {
  const [playKey, setPlayKey] = useState(0);
  const hasPlayed = playKey > 0;
  const simEntry = useSimulatedToolEntry(hasPlayed ? SCRAPE_RECORDING : null, {
    playKey,
  });
  ...
  return (
    <section className="space-y-4">
      ...
      <p className="text-xs text-muted-foreground">
        One full CARD per page with a left-to-right reading-wave shimmer while
        reading; pages start a beat apart (Browsing &lt;url&gt;), then each card
        fills in (title · snippet · char count) on completion. Press Play to
        run.
      </p>
      <div className="space-y-4">
...
function LiveResearchSection() {
  ...
  const hasPlayed = playKey > 0;
  const simEntry = useSimulatedToolEntry(
    hasPlayed ? RESEARCH_REPORT_RECORDING : null,
    { playKey },
  );
  ...
  return (
    <section className="space-y-4">
      ...
      <p className="text-xs text-muted-foreground">
        LIVE: the search conveyor + browsing activity keep the sub-agent visibly
        working; the curated report then streams into a distinct,
        slightly-narrower &quot;sub-agent report&quot; card that auto-scrolls to
        the bottom with user-scroll LOCKED. On completion it becomes scrollable
        + collapsible (none/partial/full) with the RichDocument action toolkit.
        Press Play to run.
      </p>
      <div className="space-y-4">
    ...
    <div className="mx-auto w-full max-w-3xl space-y-8 px-2 py-6">
      <header className="space-y-1">
        <h1 className="text-xl font-semibold text-foreground">
          Tool result field library — gallery
        </h1>
        <p className="text-sm text-muted-foreground">
          Every <code className="text-xs">ResultShape</code> branch rendered at
          the exact canonical chat width (
          <code className="text-xs">max-w-3xl</code>, 768px). Verification
          harness for the generic tool renderer overhaul.
        </p>
      </header>
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          ctx_patch — LIVE animation STATIC mid-stream snapshot
          (timer-independent)
        </h2>
        <p className="-mt-2 text-xs text-muted-foreground">
          A <code className="text-xs">status: &quot;progress&quot;</code> entry
          whose args already carry the whole patch — rendered straight through{" "}
          <code className="text-xs">PatchDiffInline</code>, so the
          removal-highlight → fill-in reveal runs without the Play timer
          (provable even when HMR is unstable).
        </p>
        <FixtureCard label="PatchDiffInline — LIVE reveal (static progress entry)">
          <PatchDiffInline
            entry={PATCH_LIVE_SNAPSHOT}
            events={[]}
            toolGroupId={PATCH_LIVE_SNAPSHOT.callId}
          />
        </FixtureCard>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="-mt-2 text-xs text-muted-foreground">
          A <code className="text-xs">status: &quot;progress&quot;</code> entry
          with the full result already parsed — the LIVE conveyor without the
          Play timer. Confirms the rolling-window cap (≤4 rows at once) and
          base-URL dedupe even when HMR is unstable.
        </p>
        <FixtureCard label="SearchInline — LIVE conveyor (static progress entry)">
          <SearchInline
            entry={SEARCH_LIVE_SNAPSHOT}
            events={[]}
            onOpenOverlay={() => {}}
          />
        </FixtureCard>
      ...
      <section className="space-y-4">
        ...
        <p className="-mt-2 text-xs text-muted-foreground">
          The fast-forwarded result: 3 parallel queries grouped,
          base-URL-deduped source list (the healthline + nih duplicates across
          queries collapse to one each). No AI answer (plain search) → leads
          with results. Click a row to expand the full overlay.
        </p>
        <div className="space-y-4">
      ...
      <section className="space-y-4">
        ...
        <p className="-mt-2 text-xs text-muted-foreground">
          A <code className="text-xs">status: &quot;progress&quot;</code> entry
          with NO pages parsed yet but the &quot;Browsing &lt;url&gt;&quot;
          activity events present — one reading-wave card per page, independent
          of the Play timer.
        </p>
        <FixtureCard label="ScrapeInline — READING cards (static progress entry)">
          <ScrapeInline
            entry={SCRAPE_READING_SNAPSHOT}
            events={SCRAPE_READING_SNAPSHOT.events}
            onOpenOverlay={() => {}}
          />
        </FixtureCard>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="-mt-2 text-xs text-muted-foreground">
          The common case:{" "}
          <code className="text-xs">{`{pages:[{url,content}]}`}</code> with the
          <code className="text-xs">
            {" "}
            Here is the content from page …:
            &quot;&quot;&quot;…&quot;&quot;&quot;
          </code>{" "}
          envelope stripped, title derived best-effort from the body, no preview
          image. Click a row to open the full reader overlay.
        </p>
        <div className="space-y-4">
          <FixtureCard label="ScrapeInline — filled cards, no image (raw renderer)">
            <ScrapeInline
              entry={SCRAPE_ENTRY_NO_IMAGE}
              events={[]}
              onOpenOverlay={() => {}}
            />
          </FixtureCard>
      ...
      <section className="space-y-4">
        ...
        <p className="-mt-2 text-xs text-muted-foreground">
          A page object that ALSO carries an optional preview image (rendered
          via <code className="text-xs">InlineMediaRef</code>, never a raw{" "}
          <code className="text-xs">&lt;img&gt;</code>) and an AI-review line
          (shown ONLY because it&apos;s present).
        </p>
        <FixtureCard label="ScrapeInline — page card with preview image + review line">
          <ScrapeInline
            entry={SCRAPE_ENTRY_WITH_IMAGE}
            events={[]}
            onOpenOverlay={() => {}}
          />
        </FixtureCard>
      ...
      <section className="space-y-4">
        ...
        <p className="-mt-2 text-xs text-muted-foreground">
          A <code className="text-xs">status: &quot;progress&quot;</code> entry
          with the FULL curated report in{" "}
          <code className="text-xs">result</code> — the SubagentReportBlock
          paces it client-side and pins to the bottom with user-scroll LOCKED,
          no Play timer needed. Distinct &quot;sub-agent report&quot; card,
          slightly narrower than full width, ~400px viewport.
        </p>
        <FixtureCard label="ResearchInline — streaming report (static progress entry)">
          <ResearchInline
            entry={RESEARCH_STREAMING_SNAPSHOT}
            events={[]}
            onOpenOverlay={() => {}}
          />
        </FixtureCard>
        <FixtureCard label="SubagentReportBlock — streaming (direct render)">
          <SubagentReportBlock
            ...
            streaming
            queries={[RESEARCH_REPORT_ARGS.query]}
          />
        </FixtureCard>
      </section>
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          Research report — DONE (scrollable · collapsible · RichDocument
          actions)
        </h2>
        <p className="-mt-2 text-xs text-muted-foreground">
          The settled report: free scroll in the ~400px window, Expand to full,
          collapse to the header, and the RichDocument action toolkit (copy /
          save to notes / open editor / …). Below, the full renderer with the
          report + sources summary + &quot;View full research&quot; overlay
          handoff.
        </p>
      ...
      <section className="space-y-4">
        ...
        <p className="-mt-2 text-xs text-muted-foreground">
          The research blob WITHOUT a curated report — the renderer leads with
          the sources summary; expand the row, then the overlay shows Report /
          Sources / Full Text / Input / Raw tabs.
        </p>
        <div>
          <ToolCallVisualization
            entries={[RESEARCH_ENTRY]}
            isPersisted
            hasContent
          />
        </div>
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          Dynamic (DB) renderer — `agent_call` compiled from `tool_ui` via the
          canonical runtime (click to expand)
        </h2>
        <div>
          <ToolCallVisualization
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          Skill lookup — `skill` search + get (no ids, humanized types, empty
          fields dropped)
        </h2>
        <p className="-mt-2 text-xs text-muted-foreground">
          Live wire shapes: search → one card of hint rows (label · type ·
          clamped description); get → the skill card (label · type · version ·
          description · category chips). UUIDs, enum reprs, and &quot;No result
          returned&quot; rows are gone — full payload stays in Tool Admin / Raw.
        </p>
        <ChatResultColumn>
          {SKILL_ENTRIES.map((e) => (
            <ToolCallVisualization
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          Ask-the-user — `ask_user` + `interaction_ask` (Q&amp;A rows,
          awaiting-answer state)
        </h2>
        <p className="-mt-2 text-xs text-muted-foreground">
          Known-pretty Q&amp;A on the canonical card: one condensed row per
          question with the answer beneath it; unanswered questions show a quiet
          &quot;Awaiting answer&quot;. No ids, no component_type enums, no
          option dumps.
        </p>
        <ChatResultColumn>
          {ASK_ENTRIES.map((e) => (
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          fs_list BATCH — consecutive calls consolidated into ONE card (no batch
          line, no nesting)
        </h2>
        <p className="-mt-2 text-xs text-muted-foreground">
          A run of 3 `fs_list` calls through `ToolCallBatch`: one card, one row
          per listing (name · path · counts), each row expands its entries in
          place. The old form — batch line → left rail → per-call cards — was
          the owner-flagged triple nest.
        </p>
        <ChatResultColumn>
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          DB-loaded renderers — agent-authored code from `tool_ui`, NONE in the
          codebase (click a row to expand)
        </h2>
        <p className="-mt-2 text-xs text-muted-foreground">
      ...
      <section className="space-y-4">
        ...
        <p className="-mt-2 text-xs text-muted-foreground">
          Redux/Supabase-backed: the tiny result (`{`{ id, label, updated_at }`}
          `) hydrates the live note — Edit/Preview toggle, collapsible markdown
          Preview, content stats, and "Open in Notes" (deep-linked window). Log
          in as admin@admin.com to see real content; the second row is long
          enough to collapse. Rendered in the exact chat results column (no
          surrounding card) so it matches production.
        </p>
        <ChatResultColumn>
          {NOTE_ENTRIES.map((e) => (
            <ToolCallVisualization
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          CTX renderers — context (live unified) / ctx_get / ctx_batch /
          ctx_patch (click a row to expand)
        </h2>
        <div>
          {CTX_ENTRIES.map((e) => (
            <ToolCallVisualization
      ...
      <section className="space-y-4">
        ...
        <p className="-mt-2 text-xs text-muted-foreground">
          The reloaded / persisted case: the final diff renders at once (no
          animation). str_replace tints the inserted text success, unchanged
          plain — an insert doesn&apos;t mark everything changed; overwrite
          shows the whole new body as one big insert. Reconstructed from the
          persisted args, so it&apos;s correct on reload.
        </p>
        <div className="space-y-3">
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          ArtifactResultBar — the official &quot;known pretty data&quot; header
          (working document)
        </h2>
        <p className="-mt-2 text-xs text-muted-foreground">
          A completed working-document patch through the REAL shell path: one
          full-width header, click anywhere to collapse/expand, Open is a
          bordered dropdown (Canvas · Edit · Window Panel · Tool Admin), and the
          expanded document attaches seamlessly beneath the header — one sheet.
        </p>
        <ChatResultColumn>
          <ToolCallVisualization
            entries={CTX_ENTRIES.filter(
              (e) => e.callId === "ctx-patch-overwrite",
            )}
      ...
      <section className="space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">
          Database / SQL renderers — sql / db_query / db_schema (click a row to
          expand)
        </h2>
        <div>
          {SQL_ENTRIES.map((e) => (
