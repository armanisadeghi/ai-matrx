...
// /demos/scopes/context-lab/reimagine — shared picker engine (ui-reimagine bakeoff)
//
// ONE data + selection engine consumed by every inside-variation on this
// route. All reads are REAL:
...
//
// WRITES are preview-only by demo law (a real Layer-C write from a demo is
// illegal): commits log + toast, quick-adds create local "draft" nodes in a
// module store shared by every variant on the page — create a scope in one
// picker and every other picker sees it instantly.
