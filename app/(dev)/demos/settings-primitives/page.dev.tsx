...
export default function SettingsPrimitivesDemoPage() {
  ...
  const [previewVariant, setPreviewVariant] = useState<"standard" | "compact">(
    "compact",
  );
  ...
  return (
    ...
    >
      <SettingsDesignProvider variant={previewVariant}>
        <div className="max-w-3xl mx-auto py-8 px-0">
          <div className="px-4 mb-6">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Preview settings primitives in standard or compact presentation.
              Preview only — changes here stay in this demo.
            </p>
          </div>
          ...
          <SettingsSection title="Preview">
            <SettingsSegmented
              label="Presentation"
              description="Preview the standard or compact settings layout."
            ...
            <SettingsSegmented
              label="Color preview"
              description="Preview the isolated demo canvas in light or dark mode."
              value={previewTheme}
