...
import { LocalToolsWorkshopLayout } from "../_lib/LocalToolsWorkshopLayout";
...
export default function FilesPage() {
  ...
  const textareaCls =
    "w-full text-xs font-mono rounded border px-2 py-1 bg-background resize-none";
  const isLoading = (s: string) => !!loading && activeSection === s;

  return (
    <LocalToolsPageShell>
      <LocalToolsWorkshopLayout
        sidebar={
          <>
            {/* Read */}
            ...
            <div className="p-2 space-y-1.5">
              ...
              <input
                type="text"
                value={editOldText}
                onChange={(e) => setEditOldText(e.target.value)}
                className={inputCls}
                style={{ fontSize: "16px" }}
              />
              <label className="text-[10px] text-muted-foreground">
              ...
              <Button
                ...
                onClick={() =>
                  run("edit", "Edit", {
                    file_path: editPath,
                    old_string: editOldText,
                    new_string: editNewText,
                  })
                }
              >
                {isLoading("edit") ? (
            ...
            <div className="p-2 space-y-1.5">
              ...
              <input
                type="text"
                value={globPath}
                onChange={(e) => setGlobPath(e.target.value)}
                className={inputCls}
                style={{ fontSize: "16px" }}
                placeholder="."
              />
              ...
              <div className="flex gap-1.5">
                <div className="flex-1 space-y-0.5">
                  ...
                  <input
                    type="text"
                    value={grepInclude}
                    onChange={(e) => setGrepInclude(e.target.value)}
                    className={inputCls}
                    style={{ fontSize: "16px" }}
                    placeholder="*.py"
                  />
                ...
                <div className="w-16 space-y-0.5">
                  ...
                  <input
                    ...
                    onChange={(e) => setGrepMaxResults(Number(e.target.value))}
                    className={inputCls}
                    style={{ fontSize: "16px" }}
                  />
                </div>
