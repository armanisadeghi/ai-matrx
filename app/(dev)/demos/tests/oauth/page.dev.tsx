  ...
  return (
      <div className="min-h-dvh bg-muted/50 py-8">
        <div className="max-w-5xl mx-auto px-4">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-foreground">Slack Integration</h1>
                ...
                {!isUsingDirectToken ? (
                    <div className="bg-card shadow rounded-lg p-6">
                      ...
                      <div className="space-y-4">
                        <div>
                          <label htmlFor="direct-token" className="block text-sm font-medium text-foreground mb-1">
