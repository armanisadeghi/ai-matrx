    ...
    <div className="h-full overflow-y-auto">
      <div className="container mx-auto max-w-3xl p-6 prose prose-neutral dark:prose-invert">
        ...
        <p>
          ...
          {siteConfig.legalOperatorName} (&quot;we&quot;, &quot;us&quot;). We
          provide an AI-agent platform that you access through our website at{" "}
          <a
            href="https://www.aimatrx.com/"
          ...
          &quot;Extension&quot;). This Privacy Policy explains what information
          we collect, how we use it, where it goes, and how long we keep it. We
          do not sell your data, we do not run advertising, and we do not share
        ...
        <ul>
          ...
          <li>
            The Matrx Extend Chrome extension, which runs an AI agent inside
            your browser and can read and act on the pages you choose to give
            it.
          </li>
          <li>
        ...
        <p>
          It does not cover third-party websites you visit or third-party
          services we link to. Each of those has its own policy.
        </p>
        ...
        <p>
          When you sign up we collect the information you provide: email
          address, name (if you set one), profile information, and a password
          (which is stored, hashed, by our authentication provider Supabase
          &mdash; we never see your plain-text password).
        </p>
        <p>
          The Extension stores your session locally on your device using
          Chrome&rsquo;s built-in extension storage (
          <code>chrome.storage.local</code>). Refresh tokens are encrypted at
          rest with AES-GCM before being stored.
        </p>
        ...
        <ul>
          ...
          <li>
            For Extension chats, page context derived from the active browser
            tab: URL, page title, language, viewport dimensions, the visible
            text or rendered HTML/markdown, the accessibility tree, headings,
            links, page metadata (Open Graph, Twitter, canonical, JSON-LD,
            schema.org blocks), any text you have selected, and an inventory of
            forms / images / videos / audio elements present.
          </li>
          <li>
            Prior messages in the same conversation, so the agent has
            continuity.
          </li>
          <li>
            Limited orchestration metadata: the current tab id, window id,
            open-tab count, your admin status, your selected permission mode,
            which optional permissions you have granted, and your extension
            version.
          </li>
          <li>
        ...
        <p>
          ...
          language model provider (see Section 3). Page content is processed
          solely to generate the agent&rsquo;s response.
        </p>
        ...
        <p>
          ...
          browser-level actions when you ask it to. On a fresh install, page
          content is read only for a feature you invoke. You may separately
          enable automatic capture in Settings; it is off by default and can be
          disabled at any time.
        </p>
        <ul>
          <li>
            <strong>Tabs and tab groups</strong>: list, open, close, group,
            switch to, reload, and read URL/title of tabs in your current Chrome
            profile.
          </li>
          <li>
            <strong>Browsing history</strong>: search and list your Chrome
            history when an agent tool such as &quot;search history&quot; is
            invoked.
          </li>
          <li>
          ...
          <li>
            <strong>Clipboard write</strong>: write to your clipboard (for
            example, copying an audit receipt). The Extension does not read your
            clipboard unless you grant the optional <code>clipboardRead</code>{" "}
            permission.
          </li>
          <li>
            <strong>Notifications</strong>: shown when scheduled agent tasks
            become due.
          </li>
          <li>
            <strong>Native messaging</strong>: used only if you have installed
            the optional Matrx Local desktop companion, to bridge between the
          ...
          <li>
            <strong>All-sites access</strong> (<code>&lt;all_urls&gt;</code>{" "}
            host permission): required because users choose which web pages they
            want to capture, audit, or work with. A lightweight content-script
            bridge is present on normal web pages, but it does not transmit page
            content until you invoke a feature or explicitly enable automatic
            capture.
          </li>
        </ul>
        ...
        <p>
          These are <em>not</em> requested at install time. The Extension asks
          for them only when you toggle them on in Settings &rarr; Advanced
          agent capabilities, and you can revoke them at any time from the same
          screen or from Chrome&rsquo;s extension settings.
        </p>
        <ul>
          <li>
            <strong>Cookies</strong>: read, set, or delete cookies on the
            current origin.
          </li>
          <li>
          ...
          <li>
            <strong>Tab capture</strong>: record video of the active tab when
        ...
        <ul>
          ...
          <li>
            No advertising identifiers, fingerprinting, or precise location
            data.
          </li>
          <li>No selling of personal information; no data brokers.</li>
          <li>
            No page-content capture except for a feature you invoke or automatic
            capture you explicitly enable.
          </li>
        </ul>
        ...
        <p>
          ...
          and data rates may apply. You can reply <strong>STOP</strong> to opt
        ...
        <ul>
          ...
          <li>
            ...
            delivery. Receives the mobile number and message data needed to
            verify enrollment and deliver texts. Twilio may process delivery
            metadata and opt-out keywords to operate the messaging service. (
            <a
          ...
          <li>
            ...
            OpenAI, Google (Gemini), and other providers as configured per
            agent. When you send a message to an agent, the agent backend
            forwards your message and any included page context to whichever
            provider that agent is configured to use, so it can generate a
            response. Each provider&rsquo;s own privacy and data-retention
            policies apply to that processing. We do not train models on your
            content, and we use providers&rsquo; non-training, non-logging
            endpoints where they are offered.
          </li>
        </ul>

        <h3>3.2 What is stored on our servers</h3>
        <p>
          Your account record (email, profile fields), your conversation
          history, agents and prompts you have configured, and artifacts you
          save (notes, guidance items, recorded demos that you choose to sync)
          are stored on our infrastructure (Supabase) under your user id.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            To support, debug, and improve the Service. We may review
            aggregated, de-identified usage signals (for example: error rates,
            tool failure counts) for reliability work; we do not use the
            contents of your conversations or page captures for product
            analytics.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <strong>SMS consent and delivery records:</strong> retained as
            needed to honor opt-outs, demonstrate consent, prevent abuse, and
            meet legal or carrier requirements.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <strong>Delete.</strong> Delete individual conversations or
            artifacts from inside the app. To delete your entire account, email{" "}
            <a href="mailto:support@aimatrx.com">support@aimatrx.com</a> from
            the address on file.
          </li>
          <li>
          ...
          <li>
            ...
            server-side account record is unaffected; delete it separately if
            you want it gone.
          </li>
          <li>
        ...
        <p>
          ...
          Gmail sends behind explicit user confirmation. No method of
          transmission over the Internet or method of electronic storage is 100%
          secure; we cannot guarantee absolute security but we work to keep
          practices in line with the sensitivity of the data.
        </p>
        ...
        <p>
          ...
          personal data from children under that age. If you believe a child has
          provided us personal data, please contact{" "}
          <a href="mailto:support@aimatrx.com">support@aimatrx.com</a> and we
          will delete it.
        </p>
