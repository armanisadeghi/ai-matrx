...
const NAV_ITEMS = [
  {
    label: "Overview",
    href: "/administration/database/canonicalization",
  ...
  {
    label: "Findings",
    href: "/administration/database/canonicalization/findings",
    icon: AlertTriangle,
  },
  {
  ...
  {
    label: "Function deps",
    href: "/administration/database/canonicalization/function-deps",
    icon: GitBranch,
  },
  {
    label: "Candidates",
