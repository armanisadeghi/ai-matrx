...
import { ContextItemEditView } from "@/features/scope-system/components/ContextItemEditView";
import { useAppDispatch } from "@/lib/redux/hooks";
import { fetchScopeTypes } from "@/features/agent-context/redux/scope/scopeTypesSlice";
import type { Organization } from "@/features/organizations/types";

export default function ContextItemEditPage() {
  ...
  return (
    <div className="h-dvh overflow-y-auto bg-textured">
      <div className="max-w-3xl mx-auto px-6 md:px-8 pt-12 pb-12">
        <ContextItemEditView
          orgId={org.id}
