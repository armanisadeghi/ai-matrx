// The Content Plan workspace for one site — the PILLAR MAP view.
...
export default async function BrandContentPlanMapPage({
  params,
}: {
  ...
  return (
    <ContentPlanRouteBody
      loginNext={marketingRoutes.brandContentPlanSite(brandId, siteId, "map")}
    />
  );
}
