// `/hr/me/training` — owned by the **Training** pillar spec, not by lane L1.
//
...
// the REGISTERED promise (`hr.me.training` in `lib/coming-soon/registry.ts`),
...
const PROMISE = COMING_SOON["hr.me.training"];

export default function HrMeTrainingPage() {
  return (
    <>
      <PageHeader>
      ...
      <div className="flex h-full flex-col overflow-hidden">
        <div className="min-h-0 flex-1 overflow-y-auto">
          <MeSurfaceShell operation="My training">
            {() => (
              <MePillarPlaceholder
                title={PROMISE.label}
