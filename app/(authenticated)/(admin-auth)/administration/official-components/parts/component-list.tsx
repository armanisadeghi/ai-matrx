...
export const componentList: ComponentEntry[] = [
  ...
  {
    id: "universal-image-source-picker",
    name: "Universal Image Source Picker",
    path: "components/official/UniversalImageSourcePicker.tsx",
    description:
      "4-source image picker: Upload (drag-drop/paste), Library (pick existing cloud file → auto-detect variants, generate missing via POST /assets/{id}/variants), URL (fetch+upload for variants, CORS fallback to direct use), Generate (AI pipeline placeholder). Drop-in replacement for ImageAssetUploader — identical onComplete shape (ImageUploaderResult).",
    categories: ["inputs", "media", "utilities"],
    tags: [
      "image",
      "upload",
