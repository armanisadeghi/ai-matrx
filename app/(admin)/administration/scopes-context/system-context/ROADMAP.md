...
> Cross-repo system-of-record: `/Users/armanisadeghi/code/common-docs/systems/scopes-context/FEATURE.md` — read it before touching this feature in ANY repo.
...
4. **Verify:** create a task, let it fire (or trigger manually via `/administration/automation/scheduling`), confirm the value lands + `feed_status='ok'`.
