...
// management surface: accounts, preferences health, admin privileges,
// invitations, entitlements, per-user usage & cost, and email. Each tab is its
...
export const metadata = createRouteMetadata("/administration", {
  title: "Users & Access",
  description:
    "Accounts, preferences, admin privileges, invitations, entitlements, usage, and email",
  letter: "US",
});
