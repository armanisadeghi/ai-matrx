                        ...
                        {groupedFeedback.map(({ category, key, items }) => {
                            ...
                            return (
                                <Card key={key} className="overflow-hidden">
                                    ...
                                    <button
                                        className="w-full flex items-center gap-3 py-2.5 pl-4 pr-28 lg:pr-20 hover:bg-muted/40 transition-colors text-left"
                                                ...
                                                <div className="divide-y">
                                                    {items.map(item => {
                                                        ...
                                                        return (
                                                            ...
                                                            <button
                                                                className="w-full flex items-start gap-3 py-2.5 pl-4 pr-28 lg:pr-20 hover:bg-muted/30 transition-colors text-left group"
