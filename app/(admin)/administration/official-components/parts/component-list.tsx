...
export const componentList: ComponentEntry[] = [
  ...
  },
  {
    id: "pro-input",
    name: "ProInput",
    path: "components/official/ProInput.tsx",
    description:
      "Tier-2 canonical full-feature single-line input. Built-in streaming voice, copy, inline submit button (Cmd/Ctrl+Enter or Enter), floating label, recording-protection modal, and hover controls that auto-hide while typing.",
  ...
  },
  {
    id: "pro-textarea",
    name: "ProTextarea",
    path: "components/official/ProTextarea.tsx",
    description:
      "Tier-2 canonical full-feature textarea. Built-in streaming voice, copy, submit button (Cmd/Ctrl+Enter or Enter), auto-grow, floating label, recording-protection modal, and hover controls that auto-hide while typing.",
    categories: ["inputs", "ai-helpers", "interactive"],
    tags: [
      "textarea",
      "pro",
