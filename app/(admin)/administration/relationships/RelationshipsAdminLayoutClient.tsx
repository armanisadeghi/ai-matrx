// app/(admin)/administration/relationships/RelationshipsAdminLayoutClient.tsx
...
const NAV_ITEMS = [
  ...
  {
    label: "Rules",
    href: "/administration/relationships/rules",
    icon: ListChecks,
  },
  {
    label: "Entity Types",
    href: "/administration/relationships/entity-types",
    icon: Boxes,
  },
  {
    label: "Sharing",
    href: "/administration/relationships/sharing",
    icon: Link2,
  },
  {
    label: "Explorer",
  ...
  {
    label: "Reachability",
    href: "/administration/relationships/reachability",
    icon: Waypoints,
  },
  {
    label: "Actions",
    href: "/administration/relationships/actions",
    icon: Zap,
  },
];
