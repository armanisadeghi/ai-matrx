import { AdminMandateWorkspacePage } from "@/features/admin/mandates/AdminMandateWorkspacePage";

/**
 * /administration/agents/mandates/[mandateKey] — the admin door onto THE
