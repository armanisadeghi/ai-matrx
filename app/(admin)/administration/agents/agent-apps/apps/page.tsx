...
export function agentAppsCopyConfig(): MatrxDataTableCopyConfig<AgentAppAdminView> {
  return {
    label: "Agent app",
    ...
    listAttributes: (visibleApps, allApps) => ({
      count: visibleApps.length,
      totalCount: allApps.length,
    }),
    aiVariants: (visibleApps) => [
      {
        id: "briefs",
