...
export default function SqlFunctionForm({
  ...
  const [schema, setSchema] = useState(
    functionData?.schema || DEFAULT_DATABASE_SCHEMA,
  );
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "An error occurred while saving the SQL function",
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className="mb-2">
            ...
            {showSuccess && (
              <Alert className="py-2 bg-green-100 dark:bg-green-900/20 border-green-200 dark:border-green-800">
                ...
                <AlertTitle className="text-xs text-green-800 dark:text-green-300">
                  Success
                </AlertTitle>
