    ...
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
        ...
        <CxKpiCard
          ...
          icon={Send}
          onClick={() => router.push("/administration/chat/cx-dashboard/requests")}
        />
        <CxKpiCard
          label="API Requests"
        ...
        <CxKpiCard
          ...
          icon={DollarSign}
          onClick={() => router.push("/administration/chat/cx-dashboard/usage")}
        />
        <CxKpiCard
          label="Avg Duration"
        ...
        <CxKpiCard
          ...
          icon={AlertTriangle}
          onClick={() => router.push("/administration/chat/cx-dashboard/errors")}
        />
      </div>
