-- dd226_education_publishes_nothing_to_a_signed_out_reader
...
--   education.learn_doc — the published learn-doc list runs on the PUBLISHABLE key (anon) behind the public education pages. A REAL signed-out reader.
--
-- ═══ RED, MEASURED AGAINST THE LIVE DATABASE, EVERY PROBE ROLLED BACK ═════════════════════════
--   education.content_certification — LIVE TO THE INTERNET RIGHT NOW — 9 row(s) readable by `anon` today. RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"08bede43-e47a-4777-b1bb-40798431ca5d","resource_type":"fc_set","resource_id":"f426b3f3-94aa-c0d6-6243-03bdf42dddfa","note":"AI-generated starter deck, curated by AI Matrx and pending human expert verification.","certified_at":"2026-07-14T19:24:51.750Z",…
--   education.math_course_structure — Latent (the grant is open; no row is on the public side of the gate today). RED not expressible by a visibility flip (NO-VISIBILITY-COLUMN (anon cols: 11)); the grant itself is the finding.
--   education.math_problems — LIVE TO THE INTERNET RIGHT NOW — 12 row(s) readable by `anon` today. RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"bb64dc88-3250-4824-b13b-6337740d6f34","title":"Solve equation with multiple variables on both sides","course_name":"Mathematics","topic_name":"Algebra","module_name":"Foundations of Algebra","description":"Solving for P in a simple algebraic equation wi…
--   education.quiz_sessions — Latent (the grant is open; no row is on the public side of the gate today). RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"8cab3035-deee-4de3-8bcb-e47872f1c424","title":"test","state":{"mode":"normal","quizId":"quiz_1761094015577_cjub0cnfm","results":null,"progress":{"answers":{},"startTime":1761094015577,"lastUpdated":1761094015577,"totalTimeSpent":0,"currentQuestionIndex"…
--   education.study_media — Latent (the grant is open; no row is on the public side of the gate today). RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"fa8e1200-ac7a-4648-896e-e75e635b5e96","created_at":"2026-07-07T23:44:30.277Z","updated_at":"2026-09-14T07:44:15.091Z","deleted_at":null,"visibility":"public","media_kind":"mind_map","title":"Mitochondrion Structure and Function","description":null,"stat…
--
...
begin
  for r in
    select unnest(array[
      ...
      'education.math_course_structure',
