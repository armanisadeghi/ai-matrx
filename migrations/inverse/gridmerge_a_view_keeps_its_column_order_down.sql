-- chair-step: withdraw the presentation.columnOrder view key (inverse of gridmerge_a_view_keeps_its_column_order.sql)
-- Inverse of migrations/campaign/gridmerge_a_view_keeps_its_column_order.sql: custom.view_keys()
-- back byte for byte as TABLE-PAGE-CHROME left it. A view that already stored
-- presentation.columnOrder keeps it (nothing is ever deleted); the next save of that view's
...
-- based-on: custom.view_keys() fa10da5c6aec57c1df8d9fcda3f25cb6358ffe39656a4965759e67f59f4fa386
