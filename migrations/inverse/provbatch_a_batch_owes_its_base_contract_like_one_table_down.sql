-- INVERSE of migrations/campaign/provbatch_a_batch_owes_its_base_contract_like_one_table.sql (lane PROVISION-BATCH-FIX).
-- chair-step: lane PROVISION-BATCH-FIX — undo the shared certification judgement; platform.provision and platform.provision_batch get their own certify loops back (and a batch refuses every deferred base contract again).
-- based-on: platform.provision(jsonb, text, uuid, text) a7faa43096d6eac535d473b30fdf58d69b00a54aac301f2236eafdf6b9520d5c
-- based-on: platform.provision_batch(jsonb, text, uuid, text) 62f92f141ce19e6d4c2f7eff7172d9d3c4792fa893e02bf509161086db0ad77a
-- based-on: platform.kernel_equivalence_answers() 05fbe5674b37ac1c2a97b7469b4c233155e69611d534efd79241e788e2d2391d
-- Restores platform.provision (b36487697c90…) and platform.provision_batch (653f01fad8f3…) byte-for-byte,
-- the bodies PROVISIONER-SELF-HEAL left, and platform.kernel_equivalence_answers() (ccdfc72c5c35…), then drops platform.provision_certify_judged.
...
drop function if exists platform.provision_certify_judged(text, text, text, boolean);
