-- chair-step: RC-A5d round 2 inverse — restores the ten SECURITY DEFINER doors that named records (edge labels, note/task/project/conversation titles, file names) without asking the access check about each one; puts the leak back.
-- Forward: migrations/rca5d_c_definer_doors_ask_each_record.sql. Bodies below are the live bodies of 2026-09-26 before it.
-- based-on: public.war_room_recent_activity(uuid, integer, timestamp with time zone) 0be4c047c9c13605131e23ea7d22405bf19e3810c8a1cc40118de8d1a224eca0
-- based-on: public.conversation_files(uuid) 8eadb91e86fc9a59a5c3c728c847c505aee4f9e9aca117851b7daf7ae79a6c35
-- based-on: public.get_tasks_for_entity(text, uuid) 01eebad5403212135fd4b193dd128c46daf97dd0473a65c8c20f1db864fe1843
...
-- based-on: public.conversation_shared_room_notice(uuid) 8ca7824a9690192fc6974ac4418ae288655a9b52d18976d4f7af53d155bda4cc
