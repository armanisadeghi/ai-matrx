-- INVERSE of migrations/campaign/cutoverready_the_switch_waits_until_each_copy_matches_its_older_table.sql
-- Puts platform._cutover_seam_readiness(text,uuid) back to the body it replaced (production, sha256
-- c471eb2c…) and drops platform.cutover_copy_differences(uuid). No row of any table is written.
...
$function$;
drop function if exists platform.cutover_copy_differences(uuid);
