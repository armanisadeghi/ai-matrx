-- chair-step: this RESTORES platform._provision_shape_settled() byte for byte from pg_get_functiondef taken before W2-PRED's guard repair ran, sha256 2fdc704bc624aa7c1e07f9969b269f4e6afd15f6d6b2a17ff94c0ed640b67d63. It puts back the rendered-string door comparison, which means every SECURITY DEFINER function whose signature names a non-pg_catalog type becomes unreplaceable again. A person reads the whole body below before it runs.
--
