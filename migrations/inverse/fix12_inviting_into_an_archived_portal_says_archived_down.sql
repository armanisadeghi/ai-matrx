-- additive: no
-- THE INVERSE of migrations/campaign/fix12_inviting_into_an_archived_portal_says_archived.sql:
-- the body of custom.portal_invite that file replaced, byte for byte, as read off the main
-- database on 2026-09-22 (sha256 b5897bbd5283d9699e0af44155339a979c8ff2c4a6edfca9706aa2cc8e24902e).

-- based-on: custom.portal_invite(uuid, uuid, uuid, text, uuid) 905409f5e87a1911ee915f7f90a494ed343df7db5d02928f694863e3c9659dea
