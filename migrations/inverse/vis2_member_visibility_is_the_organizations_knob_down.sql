-- VIS-2 (1 of 3) — THE INVERSE. The two kernel bodies exactly as they stood at
-- 49f6fd3e20fbe0752e9680c90d0441e98b465425b691109d5f973d45f659408e and
-- 3996d3a79e2ba8698f66e2152957f8dd73b95acacabc0e85c8f65518b0d034b4, then the knob's one
-- reader, then the knob row. Restoring the bodies BEFORE dropping the function is the whole
-- of the order: a body that still asks iam.member_lane_open after it is gone is a kernel
-- that raises on every access question in the platform.
