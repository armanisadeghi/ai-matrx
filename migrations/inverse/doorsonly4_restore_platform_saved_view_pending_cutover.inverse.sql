...
--
-- INVERSE — re-runs the same canonical route; see the campaign file. RESTORE platform.saved_view's CLIENT WRITE LANES, through the generator that now KNOWS its doors are
-- not built yet.
--
...
--
-- Inverse: migrations/inverse/doorsonly4_restore_platform_saved_view_pending_cutover.inverse.sql
set lock_timeout = '2s';
