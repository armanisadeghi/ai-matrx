-- chair-step: inverse of rca5d_g — the shortcut loaders and agent_mandate_rungs return agent names the caller may not open again.
-- based-on: public.agx_get_shortcuts_for_context(uuid, uuid) f6614d4d2a6b9b1bb0d37e5bc41b20af57ab6d773fad4a7a3fbd5495ee5bf3e6
-- based-on: public.agx_get_shortcuts_for_context_m(uuid, uuid) 2e756567bf5735000c2a1cdafee63e92f315a5bc7c9ddae356fe82fa4345daa0
...
-- based-on: public.agx_get_user_shortcuts_m() 1fea1cb483e041cd05adfd939007560599f18ae6ddca8a8150c586aa017bdf0f
-- based-on: public.agent_mandate_rungs(uuid[], boolean, uuid, integer) 1135fe870070fe37f9a9ca1cb97317ff08d569e044f4c0c573807381a64eaa34
