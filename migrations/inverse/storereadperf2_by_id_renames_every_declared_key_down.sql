-- chair-step: the inverse of migrations/campaign/storereadperf2_by_id_renames_every_declared_key.sql (lane STORE-READ-PERF-2) — puts custom._read_record_with and custom.read_records_by_ids back exactly as production held them before it (pg_get_functiondef, 2026-09-25). Nothing of anybody's data is touched.
