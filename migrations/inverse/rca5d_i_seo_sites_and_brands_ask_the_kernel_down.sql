-- chair-step: inverse of rca5d_i_seo_sites_and_brands_ask_the_kernel — puts back the doors it closed (they name records the caller may not open again).
-- based-on: seo.gsc_assert_site_access(uuid) e83b310963edb821b89ccda053092694768ff14c9d7ea26661790286791c6da9
-- based-on: seo.fn_value_rule_sync_meaning(uuid) 37575c7577394edeb904ec0cee077d585342dcb5a48667dac4bd17fc5938a736
-- based-on: seo.value_settings_scope(text, uuid) 02494a2540dc500ea79de1ab0a5e340307d1911fe0e8f880813cbae4d84b4bbd
-- based-on: seo.ai_autonomy_scope(text, uuid) b67a98b5efc6c4d6afb3656af1cce363322a15e8b0f21040e0b5462358c4246a
-- based-on: seo.fn_autonomy_apply_timed_out(uuid, text) 5828e0051828e352728a12dc73085033347b2e937e0b41f8f5c8b45f30b26611
-- based-on: web.create_site(uuid, text, text, text, jsonb, jsonb, platform.visibility, uuid) 8d056ab5f8ad41c6fc05c798eaf5c7b27d8f6fcc8ad6633265debe160b1c64ee
              ...
              or exists (select 1 from web.site s
                          where s.id = kr.site_id
                            and (s.created_by = (select auth.uid())
                                 or iam.has_org_access(s.organization_id))))
    ) then
