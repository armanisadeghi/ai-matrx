-- chair-step: RC-A5g inverse — restores get_task_associations opening the task by organization membership and returning every linked note/file/message/conversation title unchecked (re-opens the private-title leak). Run only to relieve a measured regression.
-- based-on: public.get_task_associations(uuid) 03eef3a1e4cd8aef5b4b290a210a4f397abe43a9783c37b725a7c881358e6a20
