-- INVERSE of migrations/campaign/laddercap_three_doors_ask_whether_she_may_know_the_table.sql
--
-- Takes the VIS-5 / T10 line back out of the three doors, so each describes a Table to a member
-- who may not know it exists and storerel_green.sql PART 4j names them again. That is what the
