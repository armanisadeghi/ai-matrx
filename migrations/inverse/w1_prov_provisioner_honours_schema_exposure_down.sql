...
-- They were generated by `pnpm db:based-on` AFTER the up-migration landed on the branch, and the
-- effect is a correct ordering guard: this file is refused unless the fix is actually live.
--
