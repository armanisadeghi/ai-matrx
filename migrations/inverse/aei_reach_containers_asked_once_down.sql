-- aei_reach_containers_asked_once_down — restores the body aei_reach_containers_asked_once replaced.
-- based-on: iam.accessible_entity_ids(text, permission_level, integer, boolean) 39405f3c8a49c3393fccd5847a334c9358da520978941c5230f15a2ba7bd6e7b
