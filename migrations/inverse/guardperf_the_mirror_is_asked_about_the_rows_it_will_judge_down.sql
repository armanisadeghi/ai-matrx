...
--
-- THE INVERSE of migrations/campaign/guardperf_the_mirror_is_asked_about_the_rows_it_will_judge.sql:
-- it puts the per-member mirror query back in scope over EVERY shared_only organization,
-- including one the ceiling has already excluded, and census 12 stops finishing again.
