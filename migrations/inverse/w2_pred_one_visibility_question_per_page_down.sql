-- chair-step: this RESTORES the live body of iam.accessible_entity_ids(text, permission_level, integer, boolean) byte for byte from pg_get_functiondef taken before W2-PRED ran, sha256 802578d9f6adfdb182d3d9ae7b067990c89a19dc321ac252618dd823cf60d6f0. It is the rollback BUILD-BOOK rule 4 requires for the campaign's one named exception, and it removes the custom-record arm entirely. 1,571 live policies read this function; a person reads the whole body below before it runs.
--
