-- INVERSE of migrations/campaign/portalbind_a_withdrawn_link_says_so.sql: it puts the
-- invitation row back in front of the principal, so a revoked-after-accept link reads
-- 'accepted' again and tells the customer her portal is open when it is not.
