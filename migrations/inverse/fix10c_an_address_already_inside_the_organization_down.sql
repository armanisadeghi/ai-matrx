-- The inverse of `migrations/campaign/fix10c_an_address_already_inside_the_organization_is_shared_with_not_refused.sql`.
-- It puts back the refusal — the door raises 23505 and names `custom.share_grant`
-- at the person instead of calling it — exactly as the live database carried it
-- at 2026-09-22 (pg_get_functiondef sha256
-- 4aa69f19cad8fc3a668571fb843ed79c4a1860e363977882d4e22f3936904c19).
