-- SHARED-ONLY, the inverse: the RLS mirror forgets custom/member_default_visibility and
-- the organization-member arm admits every member of a shared_only organization again.
