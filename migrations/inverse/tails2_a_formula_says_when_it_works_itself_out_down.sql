-- chair-step: puts back the custom.field_update that accepted compute_on, answered success and changed nothing. lane TAILS-2; the red twin runs these real bytes.
