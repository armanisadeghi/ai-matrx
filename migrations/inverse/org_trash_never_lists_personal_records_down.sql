-- chair-step: rule-27 inverse of org_trash_never_lists_personal_records.sql — the organization Trash lists members' personal records again (their private highlights and notes by title).
