-- INVERSE of migrations/campaign/guardswitch_the_fifth_reader.sql
-- platform.custom_field_index_ddl exactly as it stood before GUARD-SWITCH (captured live
-- 2026-09-19). Running it puts the generator back to refusing every organization for ever.
