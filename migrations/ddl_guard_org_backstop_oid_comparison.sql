...
-- single group in platform.ddl_guard_log) is a false positive.
--
...
-- THE FIX
-- -------
-- Compare by OID, never by rendered text. to_regproc() (not ::regproc) so a
...
--
-- Nothing else in the function changes. Body is the live 2026-08-21 definition.
