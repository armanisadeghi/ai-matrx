...
begin
  ...
  select om.user_id,
         ...
         uus.last_request_at, coalesce(uus.cost_24h_mcents, 0), coalesce(uus.requests_24h, 0), coalesce(uus.requests_6h, 0), c.notes
...
revoke execute on function public.org_admin_list_members(uuid) from public, anon;
