...
('matrx-user/crm-outreach-lists', 'pitch_assistant', 'Pitch assistant', 'Writes and sharpens the message a campaign actually sends — pitch body, subject-line options, and follow-ups that carry a new reason to reply. Uses only merge fields the outreach renderer can really fill.', 'single', 'db484110-610f-4dd6-8fad-21e805681cd0', 1, true, 'user-choice', 120)
