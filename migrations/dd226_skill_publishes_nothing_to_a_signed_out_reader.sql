-- dd226_skill_publishes_nothing_to_a_signed_out_reader
...
--   skill.definition — LIVE TO THE INTERNET RIGHT NOW — 57 row(s) readable by `anon` today. RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"9d40080c-e36c-4821-836d-4a925912d343","skill_id":"stat-cards","label":"Stat Cards","description":"How and when to emit a ```stats render block: a row of KPI / headline-metric cards with up/down deltas.","skill_type":"render_block","body":"# Stat Cards\n…
--   skill.render_definition — LIVE TO THE INTERNET RIGHT NOW — 200 row(s) readable by `anon` today. RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"ce7a1dac-4fb4-4712-9785-82e77c272075","block_id":"stats","label":"Stat Cards","description":"KPI / headline-metric cards from a ```stats JSON spec.","icon_name":"BarChart3","template":"```stats\n{ \"stats\": [ {\"label\":\"Revenue\",\"value\":\"$1.2M\",…
--
