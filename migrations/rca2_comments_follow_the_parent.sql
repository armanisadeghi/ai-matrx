...
--
-- Inverse: migrations/inverse/rca2_comments_follow_the_parent_down.sql.
...
begin
  ...
  -- record. Asked after the organization is resolved, so every refusal this door gave before
  -- (23502 nothing names the organization, 22023 record not in the named organization) is
  -- unchanged, and a record you may not see answers 42501 whether or not you are a member.
