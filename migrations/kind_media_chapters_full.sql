...
VALUES
  ...
  (
    ...
    'Media Chapters',
    'ts',
    $J$[{"name":"chapters","required":true,"description":"The chapters, in playback order — contiguous, gapless, strictly increasing.","type":"array"}]$J$::jsonb,
    ...
    $J${"type":"object","properties":{"chapters":{"type":"array","items":{"$ref":"#/$defs/media_chapter"},"description":"The chapters, in playback order — contiguous, gapless, strictly increasing."},"__kind":{"type":"string","description":"Block discriminator for render pipeline.","const":"media_chapters"}},"required":["__kind","chapters"],"additionalProperties":false,"$defs":{"media_chapter":{"type":"object","properties":{"start_hint":{"type":"string","description":"Start offset as MM:SS or HH:MM:SS. The first chapter is always 00:00; offsets strictly increase and never reach the media's total duration."},"title":{"type":"string","description":"Short player-chip chapter title, no trailing punctuation."},"summary":{"type":"string","description":"One sentence describing what this chapter covers."},"__kind":{"type":"string","description":"Block discriminator for render pipeline.","const":"media_chapter"}},"required":["__kind","start_hint","title"],"additionalProperties":false}}}$J$::jsonb,
    $J${"type":"object","properties":{"chapters":{"type":"array","items":{"$ref":"#/$defs/media_chapter"},"description":"The chapters, in playback order — contiguous, gapless, strictly increasing."}},"required":["chapters"],"additionalProperties":false,"$defs":{"media_chapter":{"type":"object","properties":{"start_hint":{"type":"string","description":"Start offset as MM:SS or HH:MM:SS. The first chapter is always 00:00; offsets strictly increase and never reach the media's total duration."},"title":{"type":"string","description":"Short player-chip chapter title, no trailing punctuation."},"summary":{"type":"string","description":"One sentence describing what this chapter covers."}},"required":["start_hint","title"],"additionalProperties":false}}}$J$::jsonb,
    'rc-1qvd9k81u0c4s2',
    false,
    '39c38960-d30c-4840-b0c1-c9960de95582',
    'public'
