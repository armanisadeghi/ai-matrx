-- dd226_workspace_publishes_nothing_to_a_signed_out_reader
...
--   workspace.projects — Latent (the grant is open; no row is on the public side of the gate today). RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"953487cd-b944-440c-bfdd-f7da5bd4e92d","name":"AI Matrx Onboarding System","description":"Build a full onboarding system that guides users through the most important aspects of AI Matrx and explains the core of what makes it unique — including what an ag…
--   workspace.tasks — Latent (the grant is open; no row is on the public side of the gate today). RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"00b8e0d7-abc6-48f3-afee-2bd46d5c59d0","title":"Prepare Q3 data destruction compliance report","description":"This report will confirm that all Q3 data destruction events were completed and properly documented in accordance with client defense billing gu…
--   workspace.threads — Latent (the grant is open; no row is on the public side of the gate today). RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"7302e436-0c42-4e64-a053-93cb5ea1c923","active_tab":"task","position":3,"title":"AI Matrx Onboarding System","created_at":"2026-07-23T18:11:48.188Z","updated_at":"2026-09-14T07:45:03.323Z","anchor_type":"project","anchor_id":"953487cd-b944-440c-bfdd-f7da…
--   workspace.war_rooms — Latent (the grant is open; no row is on the public side of the gate today). RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"3d5ddb12-7188-4cc9-905d-bfc6e0a894d3","title":"New War Room","description":null,"icon":null,"color":null,"active_thread_id":null,"last_opened_at":"2026-07-22T06:40:53.857Z","created_at":"2026-07-22T06:40:58.491Z","updated_at":"2026-09-14T07:45:04.199Z",…
--
