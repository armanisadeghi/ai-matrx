-- dd226_ops_publishes_nothing_to_a_signed_out_reader
...
--   ops.app_log — Latent (the grant is open; no row is on the public side of the gate today). RED not expressible by a visibility flip (NO-VISIBILITY-COLUMN (anon cols: 17)); the grant itself is the finding.
--
