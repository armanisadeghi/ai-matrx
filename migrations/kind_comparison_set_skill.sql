...
-- Keep body/label in sync if the row already exists (re-apply is safe).
UPDATE skill.definition
SET
  label = 'Comparison Tables',
  description = 'How and when to emit a comparison_set render block: the flat __kind JSON shape, criterion child nodes, value/type rules that prevent render failures, sizing guidance, and editing etiquette.',
  icon_name = 'Columns3',
