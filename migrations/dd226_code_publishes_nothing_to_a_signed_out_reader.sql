-- dd226_code_publishes_nothing_to_a_signed_out_reader
...
--   code.code_file_folders — Latent (the grant is open; no row is on the public side of the gate today). RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"3a5fc61b-016a-47f5-83f1-946807c81b70","parent_folder_id":null,"project_id":null,"workspace_id":null,"name":"matrx-admin","description":null,"icon_name":"Folder","color":"zinc","sort_order":999,"is_active":true,"created_at":"2026-04-21T06:49:18.499Z","up…
--   code.code_files — Latent (the grant is open; no row is on the public side of the gate today). RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"712b67f2-3fc0-4bd2-ace2-ce7bee7d3d9e","folder_id":null,"project_id":null,"workspace_id":null,"task_id":null,"name":"zz-surface-write-check.ts","path":"zz-surface-write-check.ts","language":"typescript","content":"/**\n * Returns the sum of two numbers.\…
--   code.code_repositories — Latent (the grant is open; no row is on the public side of the gate today). RED, one row flipped to visibility='public' inside a rolled-back transaction and read AS ANON: {"id":"b1cc93c8-45f6-41d2-84b9-f75b8ac4077b","root_folder_id":null,"project_id":null,"workspace_id":null,"name":"https://github.com/mattpocock/skills","description":null,"git_url":null,"git_branch":"main","git_provider":null,"git_commit_sha":null,"s3_bucket":n…
--
