...
--     hand-written. The stored value is the export's `.schema` — the BARE
--     JSON Schema — never the whole {name, schema, strict, unresolved}
--     response_format wrapper: a wrapper validates anything. (The original
--     apply stored wrappers; aidream wf_067_unwrap_response_format_kind_schemas
--     repaired the live rows 2026-09-19 and this file was corrected to match.)
...
VALUES
  ...
  (
    ...
    $J${"type":"object","properties":{"topic":{"type":"string","description":"The topic this page deliberately does not cover."},"to_route":{"type":"string","description":"The sibling page that owns it. Empty when no page owns it yet — a real gap."},"__kind":{"type":"string","description":"Block discriminator for render pipeline.","const":"plan_deferred_topic"}},"required":["__kind","topic"],"additionalProperties":false}$J$::jsonb,
    $J${"type":"object","properties":{"topic":{"type":"string","description":"The topic this page deliberately does not cover."},"to_route":{"type":"string","description":"The sibling page that owns it. Empty when no page owns it yet — a real gap."}},"required":["topic"],"additionalProperties":false}$J$::jsonb,
    'dj-dfk3rjy0e7vt',
    false,
    '39c38960-d30c-4840-b0c1-c9960de95582',
    'public'
  ...
  (
    ...
    $J${"type":"object","properties":{"to_route":{"type":"string","description":"The route this page should link to."},"anchor_text":{"type":"string","description":"The words the link should be wrapped around."},"reason":{"type":"string","description":"Why this link belongs on this page."},"__kind":{"type":"string","description":"Block discriminator for render pipeline.","const":"plan_planned_link"}},"required":["__kind","to_route","anchor_text"],"additionalProperties":false}$J$::jsonb,
    $J${"type":"object","properties":{"to_route":{"type":"string","description":"The route this page should link to."},"anchor_text":{"type":"string","description":"The words the link should be wrapped around."},"reason":{"type":"string","description":"Why this link belongs on this page."}},"required":["to_route","anchor_text"],"additionalProperties":false}$J$::jsonb,
    'f1-19zxcva1y5iqho',
    false,
    '39c38960-d30c-4840-b0c1-c9960de95582',
    'public'
  ...
  (
    ...
    $J${"type":"object","properties":{"heading":{"type":"string","description":"The section's heading, as it appears on the page."},"level":{"type":"number","description":"Heading level — 2 or 3. The page's h1 is the draft's own `h1` field, never a section.","default":2},"intent":{"type":"string","description":"What this section is FOR, in the writer's own words. Survives editing, and is what a re-render or a human editor reads to stay on-intent."},"body":{"type":"string","description":"The section's prose. Plain text — never HTML; the builder renders it."},"bullets":{"type":"array","items":{"type":"string"},"description":"Bulleted points belonging to this section, in order."},"__kind":{"type":"string","description":"Block discriminator for render pipeline.","const":"plan_draft_section"}},"required":["__kind","heading"],"additionalProperties":false}$J$::jsonb,
    $J${"type":"object","properties":{"heading":{"type":"string","description":"The section's heading, as it appears on the page."},"level":{"type":"number","description":"Heading level — 2 or 3. The page's h1 is the draft's own `h1` field, never a section.","default":2},"intent":{"type":"string","description":"What this section is FOR, in the writer's own words. Survives editing, and is what a re-render or a human editor reads to stay on-intent."},"body":{"type":"string","description":"The section's prose. Plain text — never HTML; the builder renders it."},"bullets":{"type":"array","items":{"type":"string"},"description":"Bulleted points belonging to this section, in order."}},"required":["heading"],"additionalProperties":false}$J$::jsonb,
    'pn-1cuqx4v1ane8b9',
    false,
    '39c38960-d30c-4840-b0c1-c9960de95582',
    'public'
  ...
  (
    ...
    $J${"type":"object","properties":{"severity":{"type":"string","enum":["blocker","important","minor"],"description":"How badly this hurts the page — blocker (must not publish), important, or minor.","default":"minor"},"section":{"type":"string","description":"The section heading this applies to. Empty means it applies to the whole page."},"problem":{"type":"string","description":"What is wrong, stated plainly."},"fix":{"type":"string","description":"What to do about it."},"__kind":{"type":"string","description":"Block discriminator for render pipeline.","const":"plan_review_issue"}},"required":["__kind","problem"],"additionalProperties":false}$J$::jsonb,
    $J${"type":"object","properties":{"severity":{"type":"string","enum":["blocker","important","minor"],"description":"How badly this hurts the page — blocker (must not publish), important, or minor.","default":"minor"},"section":{"type":"string","description":"The section heading this applies to. Empty means it applies to the whole page."},"problem":{"type":"string","description":"What is wrong, stated plainly."},"fix":{"type":"string","description":"What to do about it."}},"required":["problem"],"additionalProperties":false}$J$::jsonb,
    'jv-7yqmq41y7uxqm',
    false,
    '39c38960-d30c-4840-b0c1-c9960de95582',
    'public'
  ...
  (
    ...
    $J${"type":"object","properties":{"h1":{"type":"string","description":"The page's single h1 — its headline."},"intro":{"type":"string","description":"The opening paragraph, before the first section."},"sections":{"type":"array","items":{"$ref":"#/$defs/plan_draft_section"},"description":"The body sections, in page order."},"call_to_action":{"type":"string","description":"What the page asks the reader to do next."},"meta_title":{"type":"string","description":"The page's title tag, for search results."},"meta_description":{"type":"string","description":"The page's meta description, for search results."},"__kind":{"type":"string","description":"Block discriminator for render pipeline.","const":"plan_page_draft"}},"required":["__kind","h1"],"additionalProperties":false,"$defs":{"plan_draft_section":{"type":"object","properties":{"heading":{"type":"string","description":"The section's heading, as it appears on the page."},"level":{"type":"number","description":"Heading level — 2 or 3. The page's h1 is the draft's own `h1` field, never a section.","default":2},"intent":{"type":"string","description":"What this section is FOR, in the writer's own words. Survives editing, and is what a re-render or a human editor reads to stay on-intent."},"body":{"type":"string","description":"The section's prose. Plain text — never HTML; the builder renders it."},"bullets":{"type":"array","items":{"type":"string"},"description":"Bulleted points belonging to this section, in order."},"__kind":{"type":"string","description":"Block discriminator for render pipeline.","const":"plan_draft_section"}},"required":["__kind","heading"],"additionalProperties":false}}}$J$::jsonb,
    $J${"type":"object","properties":{"h1":{"type":"string","description":"The page's single h1 — its headline."},"intro":{"type":"string","description":"The opening paragraph, before the first section."},"sections":{"type":"array","items":{"$ref":"#/$defs/plan_draft_section"},"description":"The body sections, in page order."},"call_to_action":{"type":"string","description":"What the page asks the reader to do next."},"meta_title":{"type":"string","description":"The page's title tag, for search results."},"meta_description":{"type":"string","description":"The page's meta description, for search results."}},"required":["h1"],"additionalProperties":false,"$defs":{"plan_draft_section":{"type":"object","properties":{"heading":{"type":"string","description":"The section's heading, as it appears on the page."},"level":{"type":"number","description":"Heading level — 2 or 3. The page's h1 is the draft's own `h1` field, never a section.","default":2},"intent":{"type":"string","description":"What this section is FOR, in the writer's own words. Survives editing, and is what a re-render or a human editor reads to stay on-intent."},"body":{"type":"string","description":"The section's prose. Plain text — never HTML; the builder renders it."},"bullets":{"type":"array","items":{"type":"string"},"description":"Bulleted points belonging to this section, in order."}},"required":["heading"],"additionalProperties":false}}}$J$::jsonb,
    '1bx-1y5fksnkkmf6t',
    false,
    '39c38960-d30c-4840-b0c1-c9960de95582',
    'public'
  ...
  (
    ...
    $J${"type":"object","properties":{"route":{"type":"string","description":"The path this page lives at on the site."},"page_id":{"type":"string","description":"The CMS page row this build wrote to."},"write_target":{"type":"string","enum":["live","draft"],"description":"`live` — visitors see this now. `draft` — the page is published and its live content was deliberately left alone."},"html":{"type":"string","description":"The built markup. Author-supplied — always render sandboxed."},"css":{"type":"string","description":"Styles that accompany the markup."},"meta_title":{"type":"string","description":"The page's title tag, as built."},"meta_description":{"type":"string","description":"The page's meta description, as built."},"__kind":{"type":"string","description":"Block discriminator for render pipeline.","const":"cms_page_build"}},"required":["__kind","route"],"additionalProperties":false}$J$::jsonb,
    $J${"type":"object","properties":{"route":{"type":"string","description":"The path this page lives at on the site."},"page_id":{"type":"string","description":"The CMS page row this build wrote to."},"write_target":{"type":"string","enum":["live","draft"],"description":"`live` — visitors see this now. `draft` — the page is published and its live content was deliberately left alone."},"html":{"type":"string","description":"The built markup. Author-supplied — always render sandboxed."},"css":{"type":"string","description":"Styles that accompany the markup."},"meta_title":{"type":"string","description":"The page's title tag, as built."},"meta_description":{"type":"string","description":"The page's meta description, as built."}},"required":["route"],"additionalProperties":false}$J$::jsonb,
    'qs-ea0chx1x5zwgf',
    false,
    '39c38960-d30c-4840-b0c1-c9960de95582',
    'public'
