...
--
-- REGENERATE platform.categories THROUGH THE CANONICAL ROUTE (entity variant, token category).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_categories.inverse.sql
set lock_timeout = '2s';
