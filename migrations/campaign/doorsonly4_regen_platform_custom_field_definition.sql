...
--
-- REGENERATE platform.custom_field_definition THROUGH THE CANONICAL ROUTE (entity variant, token custom_field_definition).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_custom_field_definition.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'custom_field_definition', 'custom_field_definition', 'entity');
