...
--
-- REGENERATE iam.system_orgs THROUGH THE CANONICAL ROUTE (system variant, token system_orgs).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_iam_system_orgs.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('iam', 'system_orgs', 'system_orgs', 'system');
