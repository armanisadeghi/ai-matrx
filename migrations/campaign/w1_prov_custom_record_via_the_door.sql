...
select platform.provision($provision_spec$
{
  "schema": "custom",
  "table": "record",
  "token": "record",
  ...
  "functions": [
    {
      ...
      "arg_checks": {
        "p_organization_id": {
          ...
          "null_rule": "refused with SQLSTATE 22004; there is no default organization"
        },
        "p_table_id": {
          ...
          "null_rule": "null is legal and means a kernel record that belongs to no custom Table"
        },
        "p_data": {
          ...
          "null_rule": "null is coalesced to the empty object"
        }
      },
