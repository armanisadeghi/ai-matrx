...
--
-- REGENERATE platform.custom_entity_definition THROUGH THE CANONICAL ROUTE (entity variant, token custom_entity_definition).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_custom_entity_definition.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'custom_entity_definition', 'custom_entity_definition', 'entity');
