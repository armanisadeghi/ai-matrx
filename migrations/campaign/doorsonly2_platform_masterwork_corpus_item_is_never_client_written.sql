...
-- removing the door.
--
-- platform.masterwork_corpus_item -- CONTENT SEMANTICS.
-- An item in a Masterwork's corpus. Three readers, none of which contains a write verb.
--
-- WHY IT MATTERS: A member who writes another organization's corpus changes what its Masterwork was built from.
--
...
-- names it.
--
-- THE DOOR IS UNAFFECTED. `platform.masterwork_corpus_item` is owned by `postgres` and does NOT carry
