...
--
-- REGENERATE platform.org_module_config THROUGH THE CANONICAL ROUTE (entity variant, token org_module_config).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_org_module_config.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'org_module_config', 'org_module_config', 'entity');
