...
-- removing the door.
--
-- platform.assists -- ASSIST SEMANTICS.
-- The assist rows the shell shows. Every file that names it -- errorTierRules.ts, features/approvals/data.ts, features/masterwork/assists.ts -- contains no write verb at all.
--
-- WHY IT MATTERS: An assist a client can write is a message the platform appears to have said.
--
...
-- names it.
--
-- THE DOOR IS UNAFFECTED. `platform.assists` is owned by `postgres` and does NOT carry
