...
--
-- REGENERATE iam.org_industries THROUGH THE CANONICAL ROUTE (component variant, token org_industries).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_iam_org_industries.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('iam', 'org_industries', 'org_industries', 'component');
