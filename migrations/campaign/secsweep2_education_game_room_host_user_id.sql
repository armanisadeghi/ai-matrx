...
--
-- education.game_room.host_user_id genuinely names a person other than the writer, so pinning it to
...
-- Inverse: migrations/inverse/secsweep2_education_game_room_host_user_id.inverse.sql
...
create policy "game_room_host_user_id_is_addressable_insert" on education.game_room
...
create policy "game_room_host_user_id_is_addressable_update" on education.game_room
