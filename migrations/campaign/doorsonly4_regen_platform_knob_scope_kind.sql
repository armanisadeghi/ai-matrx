...
--
-- REGENERATE platform.knob_scope_kind THROUGH THE CANONICAL ROUTE (system variant, token knob_scope_kind).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_knob_scope_kind.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'knob_scope_kind', 'knob_scope_kind', 'system');
