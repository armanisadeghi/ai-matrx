...
--
-- REGENERATE platform.judge_verdict THROUGH THE CANONICAL ROUTE (ledger variant, token judge_verdict).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_judge_verdict.inverse.sql
set lock_timeout = '2s';
