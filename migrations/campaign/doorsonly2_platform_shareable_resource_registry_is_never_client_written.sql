...
-- removing the door.
--
-- platform.shareable_resource_registry -- GRANT SURFACE SEMANTICS.
-- Which resource kinds may be shared, read by `app/api/sharing/notify/route.ts`. No writer.
--
-- WHY IT MATTERS: A member who writes the shareable-resource registry decides what may be shared out of the platform.
--
...
-- names it.
--
-- THE DOOR IS UNAFFECTED. `platform.shareable_resource_registry` is owned by `postgres` and does NOT carry
