...
--
-- REGENERATE platform.output_feedback THROUGH THE CANONICAL ROUTE (entity variant, token output_feedback).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_output_feedback.inverse.sql
set lock_timeout = '2s';
