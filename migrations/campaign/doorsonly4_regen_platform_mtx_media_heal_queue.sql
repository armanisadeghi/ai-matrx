...
--
-- REGENERATE platform.mtx_media_heal_queue THROUGH THE CANONICAL ROUTE (system variant, token mtx_media_heal_queue).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_mtx_media_heal_queue.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'mtx_media_heal_queue', 'mtx_media_heal_queue', 'system');
