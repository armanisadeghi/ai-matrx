...
--
-- REGENERATE platform.masterwork_run THROUGH THE CANONICAL ROUTE (component variant, token masterwork_run).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_masterwork_run.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'masterwork_run', 'masterwork_run', 'component');
