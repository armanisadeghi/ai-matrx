...
--
-- REGENERATE iam.organization_preferences THROUGH THE CANONICAL ROUTE (component variant, token organization_preferences).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_iam_organization_preferences.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('iam', 'organization_preferences', 'organization_preferences', 'component');
