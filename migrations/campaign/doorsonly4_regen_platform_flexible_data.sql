...
--
-- REGENERATE platform.flexible_data THROUGH THE CANONICAL ROUTE (entity variant, token flexible_data).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_flexible_data.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'flexible_data', 'flexible_data', 'entity');
