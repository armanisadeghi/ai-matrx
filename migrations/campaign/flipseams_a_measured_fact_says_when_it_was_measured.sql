-- chair-step: lane FLIP-SEAMS — a measured readiness fact carries when it was last measured: platform._cutover_seam_readiness copies measured_at from the switch's prerequisite (the cutover census writes it on every release) so the organization's Data section can say "last measured <time>". Body otherwise byte-identical to production's.
-- based-on: platform._cutover_seam_readiness(text, uuid) 47c8ac082d48e89c180227349b59a897b2f0ee8c1bc425e71c874f6fbb4fdf95
-- lane: FLIP-SEAMS
-- INVERSE: migrations/inverse/flipseams_a_measured_fact_says_when_it_was_measured_down.sql
