...
--
-- REGENERATE iam.org_member_controls THROUGH THE CANONICAL ROUTE (entity variant, token org_member_control).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_iam_org_member_controls.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('iam', 'org_member_controls', 'org_member_control', 'entity');
