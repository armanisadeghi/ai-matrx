...
--
-- REGENERATE platform.masterwork_corpus_item THROUGH THE CANONICAL ROUTE (component variant, token masterwork_corpus_item).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_masterwork_corpus_item.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'masterwork_corpus_item', 'masterwork_corpus_item', 'component');
