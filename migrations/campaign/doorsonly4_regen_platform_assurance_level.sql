...
--
-- REGENERATE platform.assurance_level THROUGH THE CANONICAL ROUTE (system variant, token assurance_level).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_assurance_level.inverse.sql
set lock_timeout = '2s';
