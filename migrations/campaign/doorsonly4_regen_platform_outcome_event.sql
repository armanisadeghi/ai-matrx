...
--
-- REGENERATE platform.outcome_event THROUGH THE CANONICAL ROUTE (entity variant, token platform_outcome_event).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_outcome_event.inverse.sql
set lock_timeout = '2s';
