...
-- removing the door.
--
-- platform.outcome_event -- AUDIT SEMANTICS.
-- What actually happened, recorded for the CRM analytics and the marketing promoter signal. Three readers, zero write verbs.
--
-- WHY IT MATTERS: An outcome a client can write is an outcome a client can fake -- and these rows feed analytics other people act on.
--
...
-- names it.
--
-- THE DOOR IS UNAFFECTED. `platform.outcome_event` is owned by `postgres` and does NOT carry
