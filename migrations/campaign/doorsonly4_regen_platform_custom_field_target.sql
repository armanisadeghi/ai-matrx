...
--
-- REGENERATE platform.custom_field_target THROUGH THE CANONICAL ROUTE (system variant, token custom_field_target).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_custom_field_target.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'custom_field_target', 'custom_field_target', 'system');
