...
--
-- REGENERATE platform.org_change_policy THROUGH THE CANONICAL ROUTE (entity variant, token org_change_policy).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_org_change_policy.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'org_change_policy', 'org_change_policy', 'entity');
