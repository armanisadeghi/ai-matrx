...
--
-- REGENERATE platform.domain_classification THROUGH THE CANONICAL ROUTE (system variant, token domain_classification).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_domain_classification.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'domain_classification', 'domain_classification', 'system');
