...
--
-- REGENERATE platform.guided_checklist_run THROUGH THE CANONICAL ROUTE (entity variant, token guided_checklist_run).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_guided_checklist_run.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'guided_checklist_run', 'guided_checklist_run', 'entity');
