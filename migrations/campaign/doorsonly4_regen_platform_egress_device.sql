...
--
-- REGENERATE platform.egress_device THROUGH THE CANONICAL ROUTE (entity variant, token egress_device).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_egress_device.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'egress_device', 'egress_device', 'entity');
