...
--
-- REGENERATE platform.change_type_default THROUGH THE CANONICAL ROUTE (system variant, token change_type_default).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_change_type_default.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'change_type_default', 'change_type_default', 'system');
