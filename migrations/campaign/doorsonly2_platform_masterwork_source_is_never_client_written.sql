...
-- removing the door.
--
-- platform.masterwork_source -- CONTENT SEMANTICS.
-- A source a Masterwork was built from. Read in three services -- kept-sources, browse, acquisition-console -- none of which contains a write verb.
--
-- WHY IT MATTERS: A member who writes a source rewrites the provenance of somebody else's work.
--
...
-- names it.
--
-- THE DOOR IS UNAFFECTED. `platform.masterwork_source` is owned by `postgres` and does NOT carry
