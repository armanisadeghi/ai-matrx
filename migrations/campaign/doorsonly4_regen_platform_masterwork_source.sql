...
--
-- REGENERATE platform.masterwork_source THROUGH THE CANONICAL ROUTE (component variant, token masterwork_source).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_masterwork_source.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'masterwork_source', 'masterwork_source', 'component');
