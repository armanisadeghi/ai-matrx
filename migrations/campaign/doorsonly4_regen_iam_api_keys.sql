...
--
-- REGENERATE iam.api_keys THROUGH THE CANONICAL ROUTE (entity variant, token iam_api_key).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_iam_api_keys.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('iam', 'api_keys', 'iam_api_key', 'entity');
