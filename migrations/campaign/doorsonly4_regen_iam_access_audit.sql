...
--
-- REGENERATE iam.access_audit THROUGH THE CANONICAL ROUTE (restricted variant, token iam_access_audit).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_iam_access_audit.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('iam', 'access_audit', 'iam_access_audit', 'restricted');
