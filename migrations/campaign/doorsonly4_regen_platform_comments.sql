...
--
-- REGENERATE platform.comments THROUGH THE CANONICAL ROUTE (entity variant, token comment).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_comments.inverse.sql
set lock_timeout = '2s';
