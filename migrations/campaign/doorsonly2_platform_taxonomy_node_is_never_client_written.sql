...
-- removing the door.
--
-- platform.taxonomy_node -- VOCABULARY SEMANTICS.
-- The shared taxonomy. Read by the universal-settings taxonomy reader and the agent-review registry; no write verb in either.
--
-- WHY IT MATTERS: A member who writes a shared taxonomy changes the categories every organization is filed under.
--
...
-- names it.
--
-- THE DOOR IS UNAFFECTED. `platform.taxonomy_node` is owned by `postgres` and does NOT carry
