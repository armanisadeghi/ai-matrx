...
-- removing the door.
--
-- platform.repo -- CATALOGUE SEMANTICS.
-- The repository catalogue the agent-review registry reads. One reader, no write verb.
--
-- WHY IT MATTERS: A member who writes the repository catalogue points our own tooling at a repository nobody chose.
--
...
-- names it.
--
-- THE DOOR IS UNAFFECTED. `platform.repo` is owned by `postgres` and does NOT carry
