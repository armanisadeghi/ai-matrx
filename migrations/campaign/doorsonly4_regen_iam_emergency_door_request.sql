...
--
-- REGENERATE iam.emergency_door_request THROUGH THE CANONICAL ROUTE (restricted variant, token iam_emergency_door_request).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_iam_emergency_door_request.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('iam', 'emergency_door_request', 'iam_emergency_door_request', 'restricted');
