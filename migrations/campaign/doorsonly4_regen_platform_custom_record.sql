...
--
-- REGENERATE platform.custom_record THROUGH THE CANONICAL ROUTE (component variant, token custom_record).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_custom_record.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'custom_record', 'custom_record', 'component');
