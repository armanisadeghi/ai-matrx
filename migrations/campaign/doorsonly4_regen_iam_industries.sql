...
--
-- REGENERATE iam.industries THROUGH THE CANONICAL ROUTE (system variant, token industry).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_iam_industries.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('iam', 'industries', 'industry', 'system');
