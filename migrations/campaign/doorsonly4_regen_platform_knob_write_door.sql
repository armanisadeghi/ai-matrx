...
--
-- REGENERATE platform.knob_write_door THROUGH THE CANONICAL ROUTE (system variant, token knob_write_door).
--
...
--
-- Inverse: migrations/inverse/doorsonly4_regen_platform_knob_write_door.inverse.sql
set lock_timeout = '2s';
set statement_timeout = '600s';

select iam.apply_rls('platform', 'knob_write_door', 'knob_write_door', 'system');
