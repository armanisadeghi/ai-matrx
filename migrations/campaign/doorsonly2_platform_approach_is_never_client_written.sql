...
-- removing the door.
--
-- platform.approach -- VOCABULARY SEMANTICS.
-- The shared vocabulary of approaches a Masterwork can take. `features/masterwork/browse/approaches.ts` reads it and nothing writes it.
--
...
-- names it.
--
-- THE DOOR IS UNAFFECTED. `platform.approach` is owned by `postgres` and does NOT carry
