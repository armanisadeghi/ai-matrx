-- Re-run the immutable DD154 rollback-only controls after DD154a.
-- The canonical applier owns the transaction and ledger. No application rows or persistent objects change.
DO $dd154_positive$
DECLARE
