...
# matrx-envelope — type drift hitlist
...
## `features/matrx-envelope/envelope.ts` (2)

| Type | Kind | Source | Line | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| DirectiveItemApplied | interface | api-types | 45 | duplicate |  |
| DirectiveItemFailed | interface | api-types | 54 | duplicate |  |
