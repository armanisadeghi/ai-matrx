> ARCHIVED 2026-07-26 — superseded by features/files/FEATURE.md
...
| `app/(authenticated)/(admin-auth)/administration/users/feedback/components/FeedbackDetailDialog.tsx` | 2453 | (same shape — compose preview row) | Same as above; verify in the file (line 2453 is the compose-history reuse). |
| `app/(authenticated)/(admin-auth)/administration/users/feedback/components/FeedbackDetailDialog.tsx` | 2478 | (same shape — comment-attachment grid) | Same as above. |
...
- `app/(authenticated)/(admin-auth)/administration/ui/official-components/need-wrappers/screenshot-with-context.tsx:60`, `screenshot-demo.tsx:90, 100, 110` — screenshot demos
- `app/(authenticated)/(admin-auth)/administration/ui/official-components/component-displays/paste-image-handler.tsx:170` — paste-handler demo
