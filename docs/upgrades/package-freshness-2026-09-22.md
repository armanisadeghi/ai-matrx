...
- Cartesia JavaScript SDK 4.2.0. The browser adapter now maps the app's stable TTS contract onto the v4 event websocket, and voice cloning uses the v4 file API. Unsupported embedding creation and retired clone controls were removed.
