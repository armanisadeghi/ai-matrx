...
## `features/files/api/assets.ts` (1)

| Type | Kind | Source | Line | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| PreviewVariantSpec | interface | api-types | 290 | duplicate |  |

## `features/files/blocks/types.ts` (5)
...
| Type | Kind | Source | Line | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| VirtualNode | interface | api-types | 45 | duplicate |  |
| VirtualNodeField | interface | api-types | 75 | duplicate |  |
| VirtualContent | interface | api-types | 88 | duplicate |  |
| VirtualVersion | interface | api-types | 115 | duplicate |  |
| VirtualCapabilities | interface | api-types | 127 | duplicate |  |
| WriteArgs | interface | api-types | 169 | duplicate |  |
| RenameArgs | interface | api-types | 179 | duplicate |  |
| MoveArgs | interface | api-types | 185 | duplicate |  |
| CreateArgs | interface | api-types | 192 | duplicate |  |
