...
**Build:**
1. `common-docs/systems/media/media-capture/FEATURE.md` — the cross-repo system of record: metadata schema v1, TUS browser-wire contract, bounded-media-processing requirements, transcription-source contract, `audio_extracted` derivative contract, ownership map.
...
- Docs: `common-docs/systems/media/media-capture/FEATURE.md` current; repo feature docs point to it; aidream handoffs groomed per the handoff system; `features/audio/FEATURE.md` corrections landed; `features/files/handler/FEATURE.md` documents the transport policy; `/camera/admin` map complete.
