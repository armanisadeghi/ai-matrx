...
- **Test:** `http://localhost:3000/login` → `admin@admin.com` / `<see AI_ADMIN_PASSWORD in .env>` → `/rag/library` (Trash = trash-can icon in header). Verification matrix = the table in this file's git history (`git show 33ebe8345:docs/handoffs/wave-a-softdelete-spec.md`).
