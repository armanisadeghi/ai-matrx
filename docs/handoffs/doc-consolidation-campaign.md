...
**Owner:** Arman. **Created 2026-07-22** from a four-agent full inventory: ai-matrx (794 docs), aidream (774 docs), matrx-common-docs (~30 docs, healthy), skills (68 ai-matrx + 24 aidream + 29 legacy Cursor-era). Raw tables: ai-matrx artifact (sortable, published), aidream `full_table.txt` in the session scratchpad, per-agent reports in session transcripts.
