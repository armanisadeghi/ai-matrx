...
vision: [features/agents/docs/ORCHESTRAS.md, features/agents/docs/ORCHESTRAS_ROADMAP.md]
---

# Orchestras — Runtime Delegation

Execution half of Orchestras. System of record: `features/agents/docs/ORCHESTRAS.md` (+ `ORCHESTRAS_ROADMAP.md` for Phase 2+). The sibling authoring handoff (sync/inspect) finished and was deleted 2026-08-08.
