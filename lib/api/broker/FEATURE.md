...
Cross-repo system of record: `/Users/armanisadeghi/code/common-docs/systems/platform/token-broker/FEATURE.md`. Server growth (new providers/audiences): global `token-broker` skill — **server-first, always**. Repo consumption rules: `.claude/skills/token-broker-client/SKILL.md`.
