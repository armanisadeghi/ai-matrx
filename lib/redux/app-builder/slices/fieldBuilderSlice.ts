...
import {
  ...
  type FetchFieldByIdSuccessAction,
...
import type { fieldDirection, FieldOption } from "@/types/customAppTypes";
...
export const fieldBuilderSlice = createSlice({
  ...
  reducers: {
    ...
    setHelpText: (
      state,
      action: PayloadAction<{ id: string; helpText?: string }>,
    ) => {
    ...
    setIconName: (
      state,
      action: PayloadAction<{ id: string; iconName?: string }>,
    ) => {
    ...
    setComponent: (
      ...
      action: PayloadAction<{
        id: string;
        component: FieldBuilder["component"];
      }>,
    ) => {
    ...
    setDefaultValue: (
      state,
      action: PayloadAction<{ id: string; defaultValue?: unknown }>,
    ) => {
    ...
    setComponentProps: (
      ...
      action: PayloadAction<{
        id: string;
        componentProps: FieldBuilder["componentProps"];
      }>,
    ) => {
    ...
    setIncludeOther: (
      state,
      action: PayloadAction<{ id: string; includeOther?: boolean }>,
    ) => {
    ...
    setIsLocal: (
      state,
      action: PayloadAction<{ id: string; isLocal?: boolean }>,
    ) => {
    ...
    setMin: (state, action: PayloadAction<{ id: string; min?: number }>) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          min: min ?? field.componentProps.min,
        },
        isDirty: true,
      };
    },
    setMax: (state, action: PayloadAction<{ id: string; max?: number }>) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          max: max ?? field.componentProps.max,
        },
        isDirty: true,
      };
    },
    setStep: (state, action: PayloadAction<{ id: string; step?: number }>) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          step: step ?? field.componentProps.step,
        },
        isDirty: true,
      };
    },
    setRows: (state, action: PayloadAction<{ id: string; rows?: number }>) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          rows: rows ?? field.componentProps.rows,
        },
        isDirty: true,
      };
    },
    setMinDate: (
      state,
      action: PayloadAction<{ id: string; minDate?: string }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          minDate: minDate ?? field.componentProps.minDate,
        },
        isDirty: true,
      };
    },
    setMaxDate: (
      state,
      action: PayloadAction<{ id: string; maxDate?: string }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          maxDate: maxDate ?? field.componentProps.maxDate,
        },
        isDirty: true,
      };
    },
    setOnLabel: (
      state,
      action: PayloadAction<{ id: string; onLabel?: string }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          onLabel: onLabel ?? field.componentProps.onLabel,
        },
        isDirty: true,
      };
    },
    setOffLabel: (
      state,
      action: PayloadAction<{ id: string; offLabel?: string }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          offLabel: offLabel ?? field.componentProps.offLabel,
        },
        isDirty: true,
      };
    },
    setMultiSelect: (
      state,
      action: PayloadAction<{ id: string; multiSelect?: boolean }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          multiSelect: multiSelect ?? field.componentProps.multiSelect,
        },
        isDirty: true,
      };
    },
    setMaxItems: (
      state,
      action: PayloadAction<{ id: string; maxItems?: number }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          maxItems: maxItems ?? field.componentProps.maxItems,
        },
        isDirty: true,
      };
    },
    setMinItems: (
      state,
      action: PayloadAction<{ id: string; minItems?: number }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          minItems: minItems ?? field.componentProps.minItems,
        },
        isDirty: true,
      };
    },
    setGridCols: (
      state,
      action: PayloadAction<{ id: string; gridCols?: string }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          gridCols: gridCols ?? field.componentProps.gridCols,
        },
        isDirty: true,
      };
    },
    setAutoComplete: (
      state,
      action: PayloadAction<{ id: string; autoComplete?: string }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          autoComplete: autoComplete ?? field.componentProps.autoComplete,
        },
        isDirty: true,
      };
    },
    setDirection: (
      state,
      action: PayloadAction<{ id: string; direction?: fieldDirection }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          direction: direction ?? field.componentProps.direction,
        },
        isDirty: true,
      };
    },
    setCustomContent: (
      state,
      action: PayloadAction<{ id: string; customContent?: string }>,
    ) => {
    ...
    setShowSelectAll: (
      state,
      action: PayloadAction<{ id: string; showSelectAll?: boolean }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          showSelectAll: showSelectAll ?? field.componentProps.showSelectAll,
        },
        isDirty: true,
      };
    },
    setWidth: (
      state,
      action: PayloadAction<{ id: string; width?: string }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          width: width ?? field.componentProps.width,
        },
        isDirty: true,
      };
    },
    setValuePrefix: (
      state,
      action: PayloadAction<{ id: string; valuePrefix?: string }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          valuePrefix: valuePrefix ?? field.componentProps.valuePrefix,
        },
        isDirty: true,
      };
    },
    setValueSuffix: (
      state,
      action: PayloadAction<{ id: string; valueSuffix?: string }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          valueSuffix: valueSuffix ?? field.componentProps.valueSuffix,
        },
        isDirty: true,
      };
    },
    setMaxLength: (
      state,
      action: PayloadAction<{ id: string; maxLength?: number }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          maxLength: maxLength ?? field.componentProps.maxLength,
        },
        isDirty: true,
      };
    },
    setSpellCheck: (
      state,
      action: PayloadAction<{ id: string; spellCheck?: boolean }>,
    ) => {
      ...
      state.fields[id] = {
        ...
        componentProps: {
          ...field.componentProps,
          spellCheck: spellCheck ?? field.componentProps.spellCheck,
        },
        isDirty: true,
      };
    },
    ...
    addOption: (
      state,
      action: PayloadAction<{ id: string; option: FieldOption }>,
    ) => {
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchFieldsThunk.fulfilled, (state, action) => {
      ...
      const newFields = action.payload.reduce(
        (acc, field) => {
    ...
    builder.addCase(
      saveFieldAndUpdateContainerThunk.fulfilled,
      (state, action) => {
        const { field } = action.payload;
        if (field) {
          state.fields[field.id] = {
    ...
    builder.addCase(
      saveFieldAndUpdateContainerThunk.rejected,
      (state, action) => {
        state.isLoading = false;
        state.error =
          action.error.message || "Failed to save field and update container";
      },
    );
    ...
    builder.addCase(
      "fieldBuilder/fetchFieldByIdSuccess",
      (state, action: FetchFieldByIdSuccessAction) => {
        state.fields[action.payload.id] = normalizeField(action.payload);
        state.isLoading = false;
      },
    );
