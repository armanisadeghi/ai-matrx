...
export const normalizeCustomAppletConfig = (
  ...
  return {
    ...
    appletSubmitText: config.appletSubmitText ?? undefined,
    ...
    dataSourceConfig: config.dataSourceConfig ?? undefined,
    ...
    compiledRecipeId: config.compiledRecipeId ?? undefined,
    subcategoryId: config.subcategoryId ?? undefined,
...
export const dbToAppletConfig = (
  ...
  return normalizeCustomAppletConfig({
    ...
    slug: dbRecord.slug ?? undefined,
    appletIcon: dbRecord.applet_icon ?? undefined,
    appletSubmitText: dbRecord.applet_submit_text ?? undefined,
    ...
    dataSourceConfig:
      (dbRecord.data_source_config as AppletSourceConfig | null) ?? undefined,
    ...
    compiledRecipeId: dbRecord.compiled_recipe_id ?? undefined,
    subcategoryId: dbRecord.subcategory_id ?? undefined,
    imageUrl: dbRecord.image_url ?? undefined,
    imageFileId: dbRecord.image_file_id ?? undefined,
    appId: dbRecord.app_id ?? undefined,
