---
type: Reference
title: "persistence-repair-patrol — changelog"
description: "Dated change record of the persistence-repair-patrol skill and the run friction behind each rule, read when a friction review revises the skill or when tracing why a rule exists. Companion to the persistence-repair-patrol skill."
tags: [persistence-repair-patrol, skills, history]
