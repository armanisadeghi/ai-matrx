...
The primitive lives at **`lib/api/broker/`** (contract: its `FEATURE.md`; cross-repo system of record: `/Users/armanisadeghi/code/common-docs/systems/platform/token-broker/FEATURE.md`). It is complete — **consume it; never hand-roll a mint call, credential cache, or gateway fetch.**
