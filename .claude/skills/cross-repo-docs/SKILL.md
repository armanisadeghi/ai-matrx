...
2. **Placement test — "who has to read this?"**
   ...
   - Two or more repos must agree on it (a shared DB, a wire protocol, a security model, a
     ...
     repo it touches and what each one's role is** (see `systems/cms-system/FEATURE.md` — that section is
...
3. **Links between concepts are bundle-relative** (`/systems/cms-system/FEATURE.md`) — stable under moves.
