...
- MUST: a mandate is opened IN PLACE. Any `<Link>` from this surface to `/agents/mandates` or `/administration/mandates` is replaced by `useOpenMandateWindow()`; the routes stay for browsing all 365.
