...
(async () => {
  ...
  await page.goto('http://localhost:3001/knowledge/sources/6dd8b2ab-365f-41cd-bb71-2fcab39d0cfb', { waitUntil: 'domcontentloaded' });
  await page.waitForTimeout(5000);
  await page.screenshot({ path: path.join(OUT, '02c-source-loaded.png') });
  await context.close();
})();
