...
await page.screenshot({ path: '/private/tmp/claude-501/-Users-armanisadeghi-code/97ce06fb-fe43-496b-8c0d-08baed25bfa7/scratchpad/verify3/mobile_attached_top.png', fullPage: false });
// scroll to resources
const res = page.locator('text=Resources').first();
await res.scrollIntoViewIfNeeded();
await page.waitForTimeout(300);
await page.screenshot({ path: '/private/tmp/claude-501/-Users-armanisadeghi-code/97ce06fb-fe43-496b-8c0d-08baed25bfa7/scratchpad/verify3/mobile_attached_resources.png', fullPage: false });
await browser.close();
