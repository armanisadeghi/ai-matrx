...
await page.screenshot({ path: '/private/tmp/claude-501/-Users-armanisadeghi-code/97ce06fb-fe43-496b-8c0d-08baed25bfa7/scratchpad/verify3/17_top.png', fullPage: true });
console.log('url', page.url());
const uploadBtns = await page.$$eval('button', els => els.map(e=>(e.textContent||'').trim()).filter(t=>/upload/i.test(t)));
console.log('upload buttons', JSON.stringify(uploadBtns));
await browser.close();
