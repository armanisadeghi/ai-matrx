  ...
  const rows: Record<string, unknown>[] = [
    {
      ...
      team: "Platform",
      owner_email: "portal.lead@example.com",
      owner_phone: "+1 (415) 555-0142",
      spec_url: "https://example.com/specs/client-portal-redesign",
      accent: "#2563eb",
      story_points: 34,
      velocity: 8.5,
      budget: 84000,
    ...
    },
    {
      ...
      department: "Engineering",
      team: "Data",
      owner_email: "billing.lead@example.com",
      owner_phone: "+1 (415) 555-0198",
      spec_url: "https://example.com/specs/billing-migration",
      accent: "#dc2626",
      story_points: 55,
      velocity: 4.2,
      budget: 126500,
    ...
    },
    {
      ...
      department: "Engineering",
      team: "Mobile",
      owner_email: "mobile.lead@example.com",
      owner_phone: "+1 (415) 555-0173",
      spec_url: "https://example.com/specs/mobile-onboarding",
      accent: "#0d9488",
      story_points: 21,
      velocity: 6.8,
      budget: 38000,
    ...
    },
    {
      ...
      department: "Design",
      team: "Product Design",
      owner_email: "design.systems@example.com",
      owner_phone: "+1 (415) 555-0110",
      spec_url: "https://example.com/specs/design-system-v2",
      accent: "#7c3aed",
      story_points: 44,
      velocity: 9.1,
      budget: 61000,
    ...
    },
    {
      ...
      department: "Design",
      team: "Brand",
      owner_email: "brand.lead@example.com",
      owner_phone: "+1 (415) 555-0126",
      spec_url: "https://example.com/specs/brand-refresh",
      accent: "#f59e0b",
      story_points: 13,
      velocity: 0,
      budget: 27500,
    ...
    },
    {
      ...
      team: "Support",
      owner_email: "support.ops@example.com",
      owner_phone: "+1 (415) 555-0155",
      spec_url: "https://example.com/specs/support-playbooks",
      accent: "#16a34a",
      story_points: 18,
      velocity: 5.4,
      budget: 14200,
    ...
    },
    {
      ...
      department: "Operations",
      team: "Facilities",
      owner_email: "facilities@example.com",
      owner_phone: "+1 (415) 555-0187",
      spec_url: "https://example.com/specs/warehouse-move",
      accent: "#64748b",
      story_points: 29,
      velocity: 0,
      budget: 240000,
    ...
    },
    {
      ...
      team: "Content",
      owner_email: "content.lead@example.com",
      owner_phone: "+1 (415) 555-0134",
      spec_url: "https://example.com/specs/content-hub",
      accent: "#0ea5e9",
      story_points: 26,
      velocity: 7.7,
      budget: 46800,
  ...
  const rows: Record<string, unknown>[] = [
    {
      ...
      stock: 42,
      rating: 5,
      product_url: "https://example.com/products/standing-desk-60",
      categories: ["Office"],
      in_stock: true,
    ...
    },
    {
      ...
      stock: 8,
      rating: 4,
      product_url: "https://example.com/products/task-chair-mesh",
    ...
    },
    {
      ...
      stock: 130,
      rating: 4,
      product_url: "https://example.com/products/monitor-arm-dual",
    ...
    },
    {
      ...
      stock: 0,
      rating: 3,
      product_url: "https://example.com/products/filing-cabinet-3",
      categories: ["Storage"],
      in_stock: false,
      tags: ["lockable"],
    },
    {
      ...
      stock: 6,
      rating: 5,
      product_url: "https://example.com/products/desk-lamp-warm",
    ...
    },
    {
      ...
      stock: 24,
      rating: 4,
      product_url: "https://example.com/products/bookshelf-5",
      categories: ["Storage"],
      in_stock: true,
      tags: ["oak"],
    },
    {
      ...
      stock: 3,
      rating: 4,
      product_url: "https://example.com/products/conference-table-8",
    ...
    },
    {
      ...
      stock: 0,
      rating: 3,
      product_url: "https://example.com/products/acoustic-panels",
...
function buildTeamDirectory(): TableSpec {
  ...
  const rows: Record<string, unknown>[] = [
    {
      full_name: "A. Okafor",
      work_email: "a.okafor@example.com",
    ...
    },
    {
      ...
      work_email: "b.lindqvist@example.com",
    ...
    {
      full_name: "C. Moreau",
      work_email: "c.moreau@example.com",
    ...
    {
      full_name: "D. Haruna",
      work_email: "d.haruna@example.com",
    ...
    {
      full_name: "E. Vasquez",
      work_email: "e.vasquez@example.com",
    ...
    },
    {
      ...
      work_email: "f.nakamura@example.com",
    ...
    {
      full_name: "G. Abara",
      work_email: "g.abara@example.com",
    ...
    {
      full_name: "H. Petrov",
      work_email: "h.petrov@example.com",
