 ...
 * THE VIEW LAW (CLAUDE.md §Supabase, common-docs/systems/platform/db-rules/FEATURE.md §6).
 *
...
function main() {
  ...
  console.log(
    `  ${DIM}Enforcing THE SECURITY PHILOSOPHY + THE VIEW LAW (CLAUDE.md §Supabase, common-docs/systems/platform/db-rules/FEATURE.md §6)${RESET}`
  );
  console.log("");
