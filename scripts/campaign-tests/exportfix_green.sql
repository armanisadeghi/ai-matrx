...
values (:ORG, 'EXPORT-FIX Green Throwaway', 'exportfix-green-throwaway', 'EFG', :ADMIN);
...
begin
  if (select system_identifier from pg_control_system()) <> 7642734024280108049 then
    raise exception 'exportfix_green.sql runs on the MAIN database only, and this is %',
