...
\set suite 'guardswitch_green.sql'
...
values (:ORG_A, 'Rincon Plumbing Co', 'rincon-plumbing-guardswitch-a', 'RPC', :ADMIN),
       (:ORG_B, 'Ironclad Mobile Mechanic', 'ironclad-mobile-mechanic-guardswitch-b', 'IMM', :ADMIN);
