-- WRITE-PERF-4 WAVE 1 — THE NO-CHANGE CONTROL, beside the A/B gate. THE SAME 250-ROW INSERT, BEFORE AND AFTER, IN ONE
...
--
-- Run: binlocal/p.sh -f scripts/campaign-tests/writeperf4_ab.sql
\set ON_ERROR_STOP on
\set suite 'writeperf4_ab_control.sql'
