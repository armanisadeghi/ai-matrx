...
\set requires 'function:public.get_cx_conversations_shared_with_me|function:public.share_resource_with_user|function:public.grant_org_availability|relation:chat.conversation'
