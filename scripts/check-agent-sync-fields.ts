 ...
 */
const EXPECTED_PROJECT_REF = "brsgrqvjdzwihsvnfqkf";
/**
...
export function readSnapshot(path: string = SNAPSHOT_PATH): SyncFunctionSnapshot {
  ...
  return {
    ...
    project: parsed.project ?? "brsgrqvjdzwihsvnfqkf",
...
function loadSupabaseEnv(): SupabaseEnv | null {
  ...
  // publishable key above the secret key, and this RPC is not granted to anon.
...
const MCP_INSTRUCTIONS =
  `Refresh it by hand instead — as an agent, via the Supabase MCP (project brsgrqvjdzwihsvnfqkf):\n` +
