...
const ALLOWED = new Set([
  ...
  "migrations/campaign/sourcekey_the_old_key_is_refused_by_name.sql",
  "migrations/inverse/sourcekey_the_old_key_is_refused_by_name_down.sql",
  "migrations/campaign/sourcekey_the_readers_stop_accepting_the_old_key.sql",
  "migrations/inverse/sourcekey_the_readers_stop_accepting_the_old_key_down.sql",
  ...
  "scripts/campaign-tests/sourcekey_the_old_key_is_no_longer_read_red_green.sql",
