  ...
  agent: {
    Tables: {
      ...
      definition: {
        Row: {
          agent_type: string
          card_visibility: "private" | "internal" | "link" | "public"
    ...
    Views: {
      card: {
        Row: {
          agent_type: string | null
          card_visibility: "private" | "internal" | "link" | "public" | null
          category: string | null
        ...
        Relationships: [
          {
            ...
            isOneToOne: false
            referencedRelation: "template_scope_types"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      entities: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "page_annotations"
            referencedColumns: ["id"]
          },
        ]
      }
  ...
  public: {
    ...
    Functions: {
      ...
      convert_db_fields_to_frontend_registered_function:
        ...
        | { Args: { input_rows: unknown[] }; Returns: Json }
      ...
      mbr_count: {
        Args: { p_container_ids: string[]; p_container_type: string }
        Returns: {
          container_id: string
          member_count: number
        }[]
      ...
      tool_executor_walk_parents: {
        Args: { p_name: string }
        Returns: Database["tool"]["Tables"]["executor"]["Row"][]
        SetofOptions: {
          from: "*"
          to: "executor"
          isOneToOne: false
