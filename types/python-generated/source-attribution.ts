...
export const SOURCE_FEATURES = [
  ...
  "working-document",
  "action_request_park",
  "action_request_resolve",
  "action_request_continuation",
  "agent_usage_sync",
  "coverage",
  "hr",
  "human_decisions",
  ...
  "crawl_run",
  "deep_research_v1",
  "deferred_claim_recovery",
  "distillation_coherence",
  "doc_verify",
  ...
  "internal",
  "google_workspace.approval_replay",
  "kg_clustering_namer",
  "manual",
  "masterwork_build",
  "masterwork_recovery",
  ...
  "pdf-cleaner",
  "prompt",
  "proof_run:content_plan_family_grounding",
  "proof_run:news_self_validating",
  "rag",
  ...
  "registry_ingestion.pass",
  "scheduled",
  "schema_coerce",
  "seo.engine_schedule_dispatcher",
  "seo.keyword_place_backfill",
  "seo.rank_schedule",
  "seo_analysis_sweep",
